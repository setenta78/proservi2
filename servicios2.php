...
<script type="text/javascript" src="./js/capacitados.js"></script>  
...
<body onload="actualizarTamanoLista('listado');" onresize="actualizarTamanoLista('listado');">
  ...
  <input id="perfil"  type="hidden" readonly="yes" value="<?echo $codPerfil?>">
	<div style="margin-left:10px; margin-right:10px; margin-top:10px;">
		...
		<table width="100%">   
	    <tr> 
		    <td width="25%"><input type="button" name="btnNuevaReunion" id="btn100" value="NUEVO SERVICIO" <? if($codPerfil==70 || $codPerfil==80 || $codPerfil==100) echo 'disabled'; else echo 'enabled'; ?> onClick="javascript:abrirVentana('NUEVO SERVICIO ... ', '970', '550','fichaServicioCuadrante.php', '','','5','5')"></td>		
		    <!--<td>&nbsp;&nbsp;&nbsp;<a href="./manuales/REGULARIZACI�N CURSO LICENCIAS MEDICAS.pdf" target="_blank"><img src="./img/iconoPDF.ico" width="60" height="60" border="0" align="middle" alt="Descargar instructivo"/></a></td> -->
...
<?
	echo "<script>";
	//ACTIVADO 17-05-2019
	echo "corrigeLicencias('".$unidadUsuario."','".$fechaLimite."');";
	echo "leeServicios('".$unidadUsuario."','','','');";
	if ($codPerfil == 10 || $codPerfil == 20){
