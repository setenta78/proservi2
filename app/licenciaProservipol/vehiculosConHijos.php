...
<body onload="actualizarTamanoLista('listado');" onresize="actualizarTamanoLista('listado');">
	...
	<div style="margin-left:10px; margin-right:10px; margin-top:10px;">
		...
		<div id="subtitulo">En esta lista se encuentran los Vehículos asignados a esta <? if ($unidadUsuario==10270) echo "Subprefectura."; else echo "Prefectura."; ?></div>
		<div style="height:45px"></div>
		<table width="100%">   
		    <tr> 
		      <td width="25%">
		      		<input type="button" name="btnNuevaReunion" id="btn100" value="AGREGAR VEHICULO" onClick="javascript:abrirVentana('AGREGAR VEHICULO ... ', '800', '390','fichaVehiculo.php','','','5','5')">
		      </td>		
		...
		<div id="listado">
            ...
            <?
               ...
               echo "<td id='nombreColumna' width='23%' align='center'>TIPO</td>";
               echo "<td id='nombreColumna' width='23%' align='center'>MARCA/MODELO</td>";
               echo "<td id='nombreColumna' width='15%' align='center'>PATENTE</td>";
               echo "<td id='nombreColumna' width='15%' align='center'>NRO. BCU</td>";
               echo "<td id='nombreColumna' width='10%' align='center'>SECCION</td>";
...
<?
	echo "<script>";
	echo "leeVehiculos('".$unidadUsuario."');";
	echo "</script>";
?>