...
<?php
echo $muestra= "<td><a href=\"reporteZonas.php?unidad=".$unidad."&anno=".$anno."&mes=".$mes."\" \"><img src='img/microsoft-excel.png' width='50' height='52' border='0' align='middle' alt='Reporte'/></a></td>";
?>
</div>
</body>
</html>
