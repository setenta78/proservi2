...
<body onload="actualizarTamanoLista('listado');" onresize="actualizarTamanoLista('listado');">
	...
	<div style="margin-left:10px; margin-right:10px; margin-top:10px;">
		...
		<table width="100%">
		    <tr> 
		      <td width="25%">
		      	<input type="button" name="btnNuevaSolicitud" id="btnNuevaSolicitud" value="AGREGAR SOLICITUD" <? if($codPerfil==100) echo 'disabled'; else echo 'enabled'; ?> onClick="javascript:abrirVentana('AGREGAR SOLICITUD ... ', '720', '575','fichaSolicitud.php','','','5','5')">
		      </td>
			  <td width="75%">&nbsp;</td>
		    </tr>
		</table>
		...
		<div id="listado">
			...
			<table cellspacing="1" cellpadding="1" width="100%">
		        <tr> 
		          ...
		          <td id="colCodigo" class="nombreColumna" width="10%" align="center" ><label id="labColCodigo">REQUERIMIENTO MODULO</label></td>
		          <td id="colNombre" class="nombreColumna" width="20%" align="center" ><label id="labColNombre">GRUPO</label></td>
		          <td id="colGrado"  class="nombreColumna" width="4%" align="center" ><label id="labColGrado">No. SOLICITUD</label></td>
		          <td id="colGrado"  class="nombreColumna" width="8%" align="center" ><label id="labColGrado">FECHA</label></td>
		          <td id="colGrado"  class="nombreColumna" width="4%" align="center" ><label id="labColGrado">No. DIAS</label></td>
		          <td id="colGrado"  class="nombreColumna" width="4%" align="center" ><label id="labColGrado">TRAMITE No.</label></td>
		          <td id="colCargo"  class="nombreColumna" width="18%" align="center" ><label id="labColCargo">ESTADO ACTUAL</label></td>
		        </tr>
		     </table>
		    </div>
...
<?
	echo "<script>";
	echo "cargaListaSolicitudesEnTramite('".$unidadUsuario."');";
	echo "</script>";
?>