...
var Servidor="autocompletar2.php"; // Determina la pagina donde buscar
...
function selectItem(idContenido,value,cod)
{
	// Cuando pulsamos sobre el desplegable, colocamos el valor en el cuadro de texto
	document.getElementById('input').value=value;
	var str = document.getElementById('input2').value=value;
    var res = str.replace('ZONA LIB. BDO. OHIGGINS', 'ZONA LIB. BDO. O"HIGGINS');
