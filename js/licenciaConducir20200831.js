...
function licenciaSemep(){
	...
	if (document.getElementById("optionSemep").checked){
		...
		document.getElementById("textFechaHabilitacionSemep").className 					= "habilidado"; //Desactivado
		document.getElementById("textFechaRenovacionSemep").className 						= "habilidado";
		document.getElementById("imagenCalendarioHabilitacionSemep").className				= "calendarioHabilidado"; //Desactivado
		...
		document.getElementById("textFechaHabilitacionSemep").disabled						= ""; //Desactivado
