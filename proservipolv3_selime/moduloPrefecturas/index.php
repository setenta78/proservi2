<?php
session_start();
if ($_SESSION["session_autent_ingreso"] == "SI") { header("location: moduloUsuarios.php");}
...
<title>MODULO USUARIOS - PREFECTURAS</title>
...
<b>MODULO USUARIOS PROSERVIPOL V3.0 - PREFECTURAS</b>
<div class="page">
