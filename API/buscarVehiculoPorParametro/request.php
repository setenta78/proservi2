...
function rules(){
	...
	$marcaVehiculo		= $_GET['marcaVehiculo'];
	$modeloVehiculo		= $_GET['modeloVehiculo'];
	$patente			= $_GET['patenteVehiculo'];
	$incluirDeBaja		= $_GET['incluirDeBaja'];
	...
	*/
	if(count($message)>0){
		...
		return array("tipoVehiculo" 	=> $tipoVehiculo,
		  	 		 "marcaVehiculo"	=> $marcaVehiculo,
				 	 "modeloVehiculo"	=> $modeloVehiculo,
					 "patente"			=> $patente,
					 "incluirDeBaja"	=> $incluirDeBaja);
	}
}
