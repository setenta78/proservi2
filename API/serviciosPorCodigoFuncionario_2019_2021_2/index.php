...
echo _json_encode(($params["code"]<>"412") ? $objDBFuncionarioProservipolHistorico->serviciosFuncionarioPorCodigo_2019_2021_2($params['codigoFuncionario'], $params['fechaDesde'], $params['fechaHasta']) : $params);
