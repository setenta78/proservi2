	...
	<div class="content">
		...
		<h1>CURSO DE PROSERVIPOL</h1><br>
			<div style="padding-left: 35%;">
				...
				<h3 style="text-align: justify;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;- Fecha Termino del Curso: Domingo 13 de Abril de 2024 a las 23:59</h3>
		...
		<div id="formularioRegistro">
			<form method="post" action="" id="formularioMatricula" name="formularioMatricula" accept-charset="utf-8" style="position: relative; left: 15%">
				...
				<table width="75%"><tr><td align="right" width="30%">
					...
					<tr><td align="right">
					<span id="labelText">Unidad (*):</span>
					</td><td align="left">
					<input type="hidden" id="textCodUnidad" name="textCodUnidad" />
					<input type="hidden" id="textCodUnidadAll" />
					<input class="textFormulario" type="text" id="textDescUnidad" name="textDescUnidad" readonly/>
					<input type="button" id="btnAsignarUnidad" value="<<" />
					</td></tr>
					<tr><td align="right">
...
const fechaLimite = new Date('Jun 06 2080 12:00:00');
