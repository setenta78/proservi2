...
$codigo = $tipo = $fechaDesde = $fechaHasta = "";
$codigo_err = $tipo_err = $fechaDesde_err = $fechaHasta_err ="";
...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    if($input_tipo == 0){
        $tipo_err = "Por favor ingrese el tipo de movimiento a elimianar.";     
    } else{
		$tipo = $input_tipo;
    ...
    if(empty($codigo_err) && empty($tipo_err) && empty($fechaDesde_err) && empty($fechaHasta_err)){
        //validamos fechas
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="page-header">
                        <h3>Eliminar Feriados, Permiso, Licencia o Administrativo</h2>
                    </div>
