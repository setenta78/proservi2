...
<body style="margin-top:10; margin-left:10; background-color:#d0d0d0" scroll="no" onload="buscaDatosFichaLicencia(); leeTipoLicencia('cboLicencia');servicioLicenciaCorrelativo()">
...
<td><input type="text" id="txtcolor" name="txtcolor" size="1" style="text-transform:uppercase;" value="<? echo $codigoColor; ?>" readonly="yes"></td>
<td><b> FOLIO:</b></td>
<td><input type="text" id="txtfolio" name="txtfolio" size="11" value="<? echo $codigoFolio; ?>" readonly="yes" ></td>
</tr>
</table>
</div>
...
<tr>
<td align="center"><select id="cboEspecialidad" disabled="disabled" >
<option value="0">SELECCIONE UNA OPCION ...</option>
