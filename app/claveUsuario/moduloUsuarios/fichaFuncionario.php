...
<script language="javascript" src="./js/funcionesFichaFuncionario.js?v.2"></script>
...
-->
    ...
    <td></td>
		...
		<tr style="padding: 0px 0px 2px 0px">
			...
			<label id="labelUnidadUsuario" disabled>ZONA&nbsp;/&nbsp;PREFECTURA&nbsp;:&nbsp;</label></td>

			<td width="67%">
			<select id="selUnidadUsuario" disabled></select></td>
	...
	<table cellpadding="0" cellspacing="0" width="100%">
		<tr style="padding: 5px 0px 0px 0px">
			<td style="font-size:8px;" align="right">MODIFIQUE EL PERFIL DE USUARIO Y POSTERIORMENTE SELECCIONE GUARDAR</td>
		</tr>
...
<tr> 
      ...
      <td width="20%"><input id="btnGuardarFicha" type="button" id="btn100" value="GUARDAR" onClick="guardaContrasena();"></td>
