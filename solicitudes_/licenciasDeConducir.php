...
<body onload="actualizarTamanoLista('listado');" onresize="actualizarTamanoLista('listado');">
	...
	<div style="margin-left:10px; margin-right:10px; margin-top:10px;">
		...
		<div id="subtitulo">En esta lista se encuentra el personal asignado a esta Unidad y Licencias de Conducir</div>
		<div style="height:90px"></div>
		<table width="100%">   
		    <tr> 
		      <td width="25%">
		      		<!--<input type="button" name="btnNuevaReunion" id="btn100" value="AGREGAR FUNCIONARIO" onClick="javascript:abrirVentana('LICENCIA DE CONDUCIR ... ', '800', '537','fichaPersonalLicenciaConducir.php','','','5','5')">-->
		      </td>		
		...
		<div id="listado">
			...
			<table cellspacing="1" cellpadding="1" width="100%">
		        <tr> 
		          ...
		          <td id="colLicenciaSemep"     class="nombreColumna" width="6%" align="center"  onmousedown="cambiaOrdenListaLicenciaConducir(this,'licenciaSemep','desc','<?echo $unidadUsuario?>')"><label id="labColLicenciaSemep">ARCHIVO</label></td>
		        </tr>
		     </table>
		    </div>
