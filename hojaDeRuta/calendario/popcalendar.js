	...
	var imgDir = "./hojaDeRuta/calendario/images/"			// directory for images ... e.g. var imgDir="/img/"

	var gotoString = "Ir al mes actual"
	var todayString = "Hoy: "
	var weekString = "Sem"
	var scrollLeftMessage = "Seleccionar mes anterior"
	var scrollRightMessage = "Seleccionar mes siguiente"
	var selectMonthMessage = "Seleccionar mes"
	var selectYearMessage = "Seleccionar a&ntilde;o"
	var selectDateMessage = "[date]" // do not replace [date], it will be replaced by date.

	var	crossobj, crossMonthObj, crossYearObj, monthSelected, yearSelected, dateSelected, omonthSelected, oyearSelected, odateSelected, monthConstructed, yearConstructed, intervalID1, intervalID2, timeoutID1, timeoutID2, ctlToPlaceValue, ctlNow, dateFormat, nStartingYear, ctlToPlaceValue2
...
//------------------------------------TERMINAR LA FUNCION EN 0 PARA QUE INICIE EN EL DIA ACTUAL EN LA SIGUIENTE LINEA----------------------------------------------
				...
				crossobj.left =	fixedX==-1 ? ctl.offsetLeft	+ leftpos + 105 :	fixedX
				crossobj.top = fixedY==-1 ?	ctl.offsetTop +	toppos + ctl.offsetHeight +	10 :	fixedY
