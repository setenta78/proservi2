...
<body onload="actualizarTamanoLista('listado');" onresize="actualizarTamanoLista('listado');">
	...
	<div style="margin-left:10px; margin-right:10px; margin-top:10px;">
		...
		<table width="100%">   
		    <tr> 
		      <td width="25%">
		      		<input type="button" name="btnNuevaReunion" id="btn100" value="AGREGAR ARMA" onClick="javascript:abrirVentana('AGREGAR ARMA ... ', '800', '280','fichaArma.php','','','5','5')" disabled>
		      </td>		
		...
		<div id="listado">
			...
			<table cellspacing="1" cellpadding="1" width="100%">
		        <tr> 
		          ...
		          <td id="nombreColumna" width="18%" align="center">TIPO ARMA</td>
		          <td id="nombreColumna" width="28%" align="center">MARCA/MODELO</td>
		          <td id="nombreColumna" width="14%" align="center">NUMERO SERIE</td>
