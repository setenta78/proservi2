		...
		{       
			...
			if (objHttpXMLFuncionarios.responseText != "VACIO"){
				...
				for(i=0;i<xml.getElementsByTagName('funcionario').length;i++){
					...
					var nroLinea = i + 1;
					var dblClick = "javascript:abrirVentana('FUNCIONARIO', '800', '"+alto+"','fichaPersonal.php?codigoFuncionario="+codigo+"','"+nroLinea+"','','5','5')";
					...
					listadoFuncionarios += "<td width='15%' align='left'><div id='valorColumna'>"+seccion+"</div></td>"; //Celda agregada el 28-04-2015
		...
		{       
			...
			if (objHttpXMLFuncionarios.responseText != "VACIO"){
				...
				for(i=0;i<xml.getElementsByTagName('funcionario').length;i++){
					...
					var nroLinea = i + 1;
					var dblClick = "javascript:abrirVentana('FUNCIONARIO', '800', '"+alto+"','fichaPersonalAgregados.php?codigoFuncionario="+codigo+"','"+nroLinea+"','','5','5')";
...
function leedatosFuncionario(codigoFuncionario, tipo){
	...
	objHttpXMLFuncionarios.onreadystatechange=function()
	{
        ...
        var seccion  	          = ""; //Variable agregada el 28-04-2015
        var desSeccion 	          = ""; //Variable agregada el 28-04-2015
        var rut = "";
   		    ...
   		    seccion 		        = xml.getElementsByTagName('codigoSeccion')[i].text; //Tag agregado el 28-04-2015
					desSeccion 		        = xml.getElementsByTagName('seccion')[i].text; //Tag agregado el 28-04-2015
					...
					// se modifico cargo
          if (seccion == "") seccion = 0; //Control agregado el 28-04-2015
					...
					//Variable seccion agregada el 28-04-2015
					//var valoresAsignar = "'"+escalafon+"','" + grado + "','" + cargo + "','" + habilitarBotones +"','"+cuadranteCargo+"','"+dias+"',"+tipo;   
					var valoresAsignar = "'"+escalafon+"','" + grado + "','" + cargo + "'," + habilitarBotones +",'"+cuadranteCargo+"','"+dias+"','"+seccion+"',"+tipo;   
...
//Variable seccion agregada el 28-04-2014
function asignaValoresFichaFuncionario(escalafon, grado, cargo, habilitarBotones, cuadranteCargo, dias, seccion, tipo){
	...
	if (cargaCargos == 1 && cargaEscalafon == 1){
		...
		if (tipo == 0) document.getElementById("selSeccion").value 		= seccion; //Control agregado el 28-04-2015
		if (tipo == 0) document.getElementById("seccionBaseDatos").value 		= seccion; //Control agregado el 28-04-2015
...
function actualizarFuncionario(){
    ...
    var seccion				 = document.getElementById("selSeccion").value;	//Variable agregada el 28-04-2015
...
function actualizarFuncionarioPaso(){
    ...
    var seccion				 = document.getElementById("selSeccion").value;	//Variable agregada el 28-04-2015
    //var dias				 = document.getElementById("selSeccion").value;
...
function nuevoFuncionario(){
	...
	parametros += "&apellidoPaterno="+apellidoPaterno+"&apellidoMaterno="+apellidoMaterno+"&primerNombre="+primerNombre;
	parametros += "&segundoNombre="+segundoNombre+"&codigoCargo="+codigoCargo+"&unidadUsuario="+unidadUsuario+"&fechaCargo="+fechaCargo;
	parametros += "&codigoCuadrante="+codigoCuadrante+"&seccion="+seccion+"&dias="+dias;
...
function validarFichaFuncionario(){
	...
	var unidadBloqueada		= top.document.getElementById("textUnidadBloqueada").value;
   	...
   	var seccion				= document.getElementById("selSeccion").value; //Variable agregada el 29-04-20|5
	var tipoUnidad	        = document.getElementById("tipoUnidad").value; //Variable agregada el 29-04-20|5
	...
	if (codigoCargo == 0) {
    	...
    	//Validacion agregada el 29-04-2015
...
//Fin validacion
	...
	//Se agrego condicion el 29-4-2015
