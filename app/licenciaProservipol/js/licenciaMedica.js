...
function validarLicenciaMedica(){
  ...
  fechaRep = new Date(parts[2], parts[1]-1, parts[0]);
	...
	if (color == "") {
		alert("DEBE INDICAR EL COLOR DE "+tipoTexto+" ...... 	     ");
...
function validarSubir(){
	...
	if(color == "MP" && folio != 0){
		document.getElementById('txtfolio').value = "2017"+folio;
 ...
 // var fecha2	 = "30000101";
  ...
  var servicio=document.getElementById("servicio").value;
	...
	var arreglo = new Array();
	 ...
	 //alert("codigoFuncionario="+codigoFuncionario+"&fecha1="+fecha1+"&fecha2="+fecha2+"&servicio="+servicio);
	   
    var mensaje="";
    var objHttpXMLFuncionarios = new AJAXCrearObjeto();
	 objHttpXMLFuncionarios.open("POST","./xml/xmlLicenciaMedica/xmlListaServiciosPorFuncionario.php",false);
	 objHttpXMLFuncionarios.setRequestHeader("Content-Type","application/x-www-form-urlencoded");
	 objHttpXMLFuncionarios.send(encodeURI("codigoFuncionario="+codigoFuncionario+"&fecha1="+fecha1+"&fecha2="+fecha2+"&fechaIR="+fechaRealI+"&fechaTR="+fechaRealT+"&servicio="+servicio));  
    //alert(objHttpXMLFuncionarios.responseText); 
    var xml = objHttpXMLFuncionarios.responseXML.documentElement;
	//return xml.getElementsByTagName('servicio')[0]; 
   //alert(objHttpXMLFuncionarios.responseText);
...
function validaPermiso(){
	var valor = document.getElementById("txtcolor").value;
	if(valor == "PP"){
		document.getElementById('seccion5').style.display="none";
		document.getElementById('seccion4').style.display="none";
		document.getElementById('seccion3').style.display="none";
...
function cargaEspecialidades(){	
	...
	objHttpXMLEspecialidades.onreadystatechange=function(){
		if(objHttpXMLEspecialidades.readyState == 4){  
			...
			var lista = "<select id='cboEspecialidad'><option value='0'>SELECCIONE UNA OPCION ...</option>";
			...
			for(i=0;i<cantidad;i++){
				...
				lista += "<option value='"+codigo+"'>"+descripcion+"</option>";
			}
			//alert(lista);
			document.getElementById("EspecialidadList").innerHTML = lista+"</select>";
			}
		}
	}
}