...
<body onload="actualizarTamanoLista('listado');" onresize="actualizarTamanoLista('listado');">
	...
	<div style="margin-left:10px; margin-right:10px; margin-top:10px;">
		...
		<table width="100%">   
		    <tr> 
		      <td width="25%"><input type="button" name="btnNuevaReunion" id="btn100" value="NUEVO SERVICIO" onClick="javascript:abrirVentana('NUEVO SERVICIO ... ', '970', '550','fichaServicioEspecializadas.php', '','','5','5')"></td>	
		        <td>&nbsp;&nbsp;&nbsp;<a href="../manuales/REGULARIZACIÓN CURSO LICENCIAS MEDICAS.pdf" target="_blank"><img src="../img/iconoPDF.ico" width="60" height="60" border="0" align="middle" alt="Descargar instructivo"/></a></td>	
