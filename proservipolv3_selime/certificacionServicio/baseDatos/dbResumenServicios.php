...
//    )
//    )
//    GROUP BY TIPO_ESCALAFON.TESC_CODIGO
//    ORDER BY
...
//$sql1 = "
//     SELECT                      
//PCION  TIPO_ESCALAFON.TESC_DESCRI,
//DESCR  COUNT(TIPO_ESCALAFON.TESC_IPCION) AS CANT_FUNCIONARIOS
//     FROM                        
//       FUNCIONARIO               
//ONARI  INNER JOIN GRADO ON (FUNCIO.ESC_CODIGO = GRADO.ESC_CODIGO)
//O = G  AND (FUNCIONARIO.GRA_CODIGRADO.GRA_CODIGO)
//IONAR  LEFT OUTER JOIN CARGO_FUNCIO ON (FUNCIONARIO.FUN_CODIGO = CARGO_FUNCIONARIO.FUN_CODIGO)
//RADO.  INNER JOIN ESCALAFON ON (GESC_CODIGO = ESCALAFON.ESC_CODIGO)
//ON (E  INNER JOIN TIPO_ESCALAFON SCALAFON.TESC_CODIGO = TIPO_ESCALAFON.TESC_CODIGO)
//     WHERE                       
//GO =   CARGO_FUNCIONARIO.UNI_CODI'".$unidad."' AND 
//ESDE   (CARGO_FUNCIONARIO.FECHA_D<= '".$fecha."' AND 
//STA >  CARGO_FUNCIONARIO.FECHA_HA '".$fecha."' OR 
//SDE <  CARGO_FUNCIONARIO.FECHA_DE= '".$fecha."' AND 
//STA I  CARGO_FUNCIONARIO.FECHA_HAS NULL AND 
//NOT N  FUNCIONARIO.UNI_CODIGO IS ULL AND 
//ARGO_  FUNCIONARIO.UNI_CODIGO = CFUNCIONARIO.UNI_CODIGO)
//     GROUP BY                    
//PCION  TIPO_ESCALAFON.TESC_DESCRI
//     ORDER BY                    
...
//if ($myrow1 = mysql_fetch_array($result1)){
	...
	echo "<tr>";
	//echo "<td width='18%' align='right'>Personal Unidad&nbsp;:&nbsp;</td>";
	...
	echo "</tr>";
	//echo "<tr>";
	//echo "<td width='18%' align='right'></td>";
	//echo "<td width='50%' colspan='2' align='left' class='dato'>".$myrow1[TESC_DESCRIPCION]."</td>";
	//echo "<td width='32%' align='left' class='dato'>".$myrow1[CANT_FUNCIONARIOS]."</td>";
	//echo "</tr>";
...
///////// FUNCIONARIOS AGREGADOS A LA UNIDAD
...
AND (CARGO_FUNCIONARIO.CAR_CODIGO=3000 OR CARGO_FUNCIONARIO.CAR_CODIGO=3100 OR CARGO_FUNCIONARIO.CAR_CODIGO=3001 OR CARGO_FUNCIONARIO.CAR_CODIGO=3002 OR CARGO_FUNCIONARIO.CAR_CODIGO=3003 OR CARGO_FUNCIONARIO.CAR_CODIGO=3004 OR CARGO_FUNCIONARIO.CAR_CODIGO=3005)
...
//    )
//    )
//AND CARGO_FUNCIONARIO.CAR_CODIGO=3000 OR CARGO_FUNCIONARIO.CAR_CODIGO=3100
//AND CARGO_FUNCIONARIO.UNI_AGREGADO='".$unidad."'
//
//    GROUP BY TIPO_ESCALAFON.TESC_CODIGO, CARGO_FUNCIONARIO.UNI_CODIGO
//    ORDER BY
...
///////// FUNCIONARIOS AGREGADOS A OTRA UNIDAD
...
//OR CARGO_FUNCIONARIO.CAR_CODIGO=6000
//)
//
//    GROUP BY 
//    TIPO_ESCALAFON.TESC_CODIGO,
...
///////// FUNCIONARIOS QUE NO FIGURAN EN SERVICIO
...
//AND CARGO_FUNCIONARIO.CAR_CODIGO != 7000
//
//AND FUNCIONARIO.FUN_CODIGO NOT IN (
//									SELECT                                                                           
...
//    OR
//    (CARGO_FUNCIONARIO.FECHA_DESDE <= '".$fecha."' AND CARGO_FUNCIONARIO.FECHA_HASTA IS NULL AND FUNCIONARIO.UNI_CODIGO IS NOT NULL AND FUNCIONARIO.UNI_CODIGO = CARGO_FUNCIONARIO.UNI_CODIGO)
//    )
//AND CARGO_FUNCIONARIO.CAR_CODIGO != 1000 AND CARGO_FUNCIONARIO.CAR_CODIGO != 2000 AND CARGO_FUNCIONARIO.CAR_CODIGO != 3000 AND CARGO_FUNCIONARIO.CAR_CODIGO != 4000 AND CARGO_FUNCIONARIO.CAR_CODIGO != 4100 AND CARGO_FUNCIONARIO.CAR_CODIGO != 5000 AND CARGO_FUNCIONARIO.CAR_CODIGO != 6000 AND CARGO_FUNCIONARIO.CAR_CODIGO != 7000 AND CARGO_FUNCIONARIO.CAR_CODIGO != 3500
//AND FUNCIONARIO.FUN_CODIGO NOT IN  (SELECT
//						          		FUNCIONARIO_SERVICIO.FUN_CODIGO
//						        	FROM
//						          		FUNCIONARIO_SERVICIO
//						          		INNER JOIN SERVICIO ON (FUNCIONARIO_SERVICIO.UNI_CODIGO = SERVICIO.UNI_CODIGO)
...
//    CARGO_FUNCIONARIO.FECHA_DESDE <= '".$fecha."' AND (CARGO_FUNCIONARIO.FECHA_HASTA > '".$fecha."' OR CARGO_FUNCIONARIO.FECHA_HASTA IS NULL) AND
//    FUNCIONARIO.FUN_CODIGO NOT IN (SELECT
//	  			          		   FUNCIONARIO_SERVICIO.FUN_CODIGO
...
AND CARGO_FUNCIONARIO.CAR_CODIGO != 1000 AND CARGO_FUNCIONARIO.CAR_CODIGO != 2000 AND CARGO_FUNCIONARIO.CAR_CODIGO != 3000 
	...
	AND CARGO_FUNCIONARIO.CAR_CODIGO != 6000 AND CARGO_FUNCIONARIO.CAR_CODIGO != 7000 AND CARGO_FUNCIONARIO.CAR_CODIGO != 7010 
...
///////// FUNCIONARIOS CON MAS DE UN SERVICIO
...
while ($myrow1 = mysql_fetch_array($result1)){
	...
	if ($codigoFunAux2!=$myrow1[FUN_CODIGO]){
		...
		if ($codigoFunAux2 != ""){
			//echo $codigoFunAux2;
			//echo "cantidadDeAsignaciones " . $cantidadDeAsignaciones;      
			//echo "cantidadColacion " . $cantidadColacion; 
...
// HORAS ASIGNADAS POR FUNCIONARIO
...
//  SUM(IF(SERVICIO.HORA_TERMINO > SERVICIO.HORA_INICIO,((TIME_TO_SEC(SERVICIO.HORA_TERMINO) - TIME_TO_SEC(SERVICIO.HORA_INICIO)) / 60),(1440 - (TIME_TO_SEC(SERVICIO.HORA_INICIO) - TIME_TO_SEC(SERVICIO.HORA_TERMINO)) / 60))) AS TIEMPO
//FROM
//  FUNCIONARIO_SERVICIO
//  INNER JOIN SERVICIO ON (FUNCIONARIO_SERVICIO.UNI_CODIGO = SERVICIO.UNI_CODIGO)
//  AND (FUNCIONARIO_SERVICIO.CORRELATIVO_SERVICIO = SERVICIO.CORRELATIVO_SERVICIO)
...
//  FUNCIONARIO_SERVICIO.FUN_CODIGO";
	...
	//		  FUNCIONARIO.FUN_NOMBRE2,
	//		  GRADO.GRA_DESCRIPCION,
	//		  SUM(IF (SERVICIO.TSERV_CODIGO <> 22, IF(SERVICIO.HORA_TERMINO > SERVICIO.HORA_INICIO, ((TIME_TO_SEC(SERVICIO.HORA_TERMINO) - TIME_TO_SEC(SERVICIO.HORA_INICIO)) / 60),(1440 - (TIME_TO_SEC(SERVICIO.HORA_INICIO) - TIME_TO_SEC(SERVICIO.HORA_TERMINO)) / 60)), IF (SERVICIO.HORA_TERMINO > SERVICIO.HORA_INICIO, IF(((TIME_TO_SEC(SERVICIO.HORA_TERMINO) - TIME_TO_SEC(SERVICIO.HORA_INICIO))/60) < 61,((TIME_TO_SEC(SERVICIO.HORA_TERMINO) - TIME_TO_SEC(SERVICIO.HORA_INICIO))/60)+1440,((TIME_TO_SEC(SERVICIO.HORA_TERMINO) - TIME_TO_SEC(SERVICIO.HORA_INICIO))/60)),(1440 - (TIME_TO_SEC(SERVICIO.HORA_INICIO) - TIME_TO_SEC(SERVICIO.HORA_TERMINO)) / 60)))) AS TIEMPO
	//		FROM
	//		  FUNCIONARIO_SERVICIO
	//		  INNER JOIN SERVICIO ON (FUNCIONARIO_SERVICIO.UNI_CODIGO = SERVICIO.UNI_CODIGO)
	//		  AND (FUNCIONARIO_SERVICIO.CORRELATIVO_SERVICIO = SERVICIO.CORRELATIVO_SERVICIO)
...
//echo $sql1;
	...
	$tiempoPromedio = $tiempoTotal/$totalPersonalHoras;
...
// CANTIDAD DE PERSONAL QUE NO OFERTA DIA POR TIPO 
