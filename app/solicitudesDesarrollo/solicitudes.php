...
<body onload="actualizarTamanoLista('listado');" onresize="actualizarTamanoLista('listado');">
	...
	<input type="hidden" value="<?echo $fecha?>" name="fecha" id="fecha"/>
	<div style="margin-left:10px; margin-right:10px; margin-top:10px;">
		<div id="titulo">SOLICITUDES</div>
		<div id="subtitulo">En esta lista se encuentran las solicitudes de requerimientos realizadas por esta Unidad.</div>
		<div style="height:130px"></div>
		<table width="100%">   
		    <tr> 
		      <td width="25%">
		      		<input type="button" name="btnNuevaReunion" id="btn100" value="AGREGAR SOLICITUD" onClick="javascript:abrirVentana('AGREGAR SOLICITUD ... ', '720', '575','fichaSolicitud.php','','','5','5')">
		      </td>		
		...
		<div id="listado">
			...
			<table cellspacing="1" cellpadding="1" width="100%">
		        <tr> 
		          ...
		          <td id="colNombre" class="nombreColumna" width="20%" align="center"  onmousedown="cambiaOrdenLista(this,'nombre','desc','<?echo $unidadUsuario?>')"><label id="labColNombre">GRUPO</label></td>
		          <!-- <td id="colGrado"  class="nombreColumna" width="20%" align="center"  onmousedown="cambiaOrdenLista(this,'grado','desc','<?echo $unidadUsuario?>')"><label id="labColGrado">IDENTIFICADOR</label></td> -->
		          ...
		          <td id="colCargo"  class="nombreColumna" width="18%" align="center"  onmousedown="cambiaOrdenLista(this,'cargo','desc','<?echo $unidadUsuario?>')"><label id="labColCargo">ESTADO ACTUAL</label></td>
		        </tr>
		     </table>
		    </div>
