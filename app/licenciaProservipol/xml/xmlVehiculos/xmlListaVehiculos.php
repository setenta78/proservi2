<?
	...
	$objVehiculos->listaTotalVehiculos($unidad, $vehiculoBuscar, $tipoVehiculo, $camporOrden, $sentidoOrden, $tipoEstado, &$vehiculos);
	...
	echo "<?xml version=\"1.0\" encoding=\"ISO-8859-1\"?>";
  	echo "<root>";
   	for ($i=0; $i<$cantidad; $i++){
        ...
        echo "<seccion>".$vehiculos[$i]->getSeccion()->getDescripcion()."</seccion>"; //Tag agregado el 05-05-2015
	 	echo "</vehiculo>";
 	}
	echo "</root>";
 ?>