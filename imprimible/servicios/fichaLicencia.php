...
$pdf->ezText(utf8_encode("<b>CONSTANCIA DE RECEPCIÓN DE LICENCIA MÉDICA PARA EL REGISTRO EN PROSERVIPOL</b>"),10,array('justification'=>'left'));
$pdf->ezSetMargins(30,30,70,30);
$pdf->ezText("",10);
$pdf->ezText("",10);
$pdf->ezText("",10);
$pdf->ezText(utf8_encode("Con fecha ".$fechaRegistro.", en el Cuartel Policial ".$uniDescripcion." se ha recibido copia de la licencia médica color ".$color." Folio ".$folio." correspondiente al Sr(a) ".$grado." ".$nombre."."),10,array('justification'=>'left'));
$pdf->ezText("",10);
$pdf->ezText(utf8_encode("La licencia en comento es del tipo ".$tipoLicencia." y fue emitida con fecha de reposo desde el día ".$fechaInicio." por un total de ".$dias." días."),10,array('justification'=>'left'));
$pdf->ezText("",10);
$pdf->ezText("",10);
$pdf->ezText("",10);
$pdf->ezSetMargins(30,30,90,30);
...
$pdf->ezText("",10);
$pdf->ezText(utf8_encode("<b>Este procedimiento sólo regula el registro de licencias en el PROSERVIPOL y su relación con los servicios. No reemplaza los plazos, procedimiento habitual y/o exigencias legales que involucra la generación y presentación de licencias médicas, especialmente para funcionarios CPR.</b>"),10,array('justification'=>'left'));
$pdf->ezSetMargins(30,30,70,30);
$pdf->ezText("",10);
$pdf->ezText("",10);
$pdf->ezText("",10);
$pdf->ezText(utf8_encode("Copia de la licencia recibida por: ".$GradoProservipol." ".$UsuarioProservipol." "),10,array('justification'=>'left'));
$pdf->ezText("",10);
$pdf->ezText("",10);
$pdf->ezText("",10);
