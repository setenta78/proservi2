...
<legend style="font-weight:bold;font-family:Verdana;font-size: 12px;color:#00000;">CONSULTAS DIPECAR&nbsp;<img src="img/Search-icon.png" height="" width="" border="0" align="middle"></legend>
<br>
<table border="0">
<tr>
...
<br/>
&nbsp;&nbsp;<input type="button" id="btn"  value="CONSULTAR" title="CONSULTAR" onClick="consultarServicio();"/><input type="hidden" name="grabar" value="si">
