...
if ($codigoFuncionarioUsuario == "992264V" || $codigoFuncionarioUsuario == "994926F" || $codigoFuncionarioUsuario == "940114W" || $codigoFuncionarioUsuario == "007065Z" || $codigoFuncionarioUsuario == "009252K" ||  $codigoFuncionarioUsuario == "036001N" ||  $codigoFuncionarioUsuario == "036005J" || $codigoFuncionarioUsuario == "035957P" || $codigoFuncionarioUsuario == "010948H") $codigoPerfil = 180;
if ($codigoFuncionarioUsuario == "007173S" || $codigoFuncionarioUsuario == "007174T" || $codigoFuncionarioUsuario == "953162X" || $codigoFuncionarioUsuario == "981445Q") $codigoPerfil = 190;
/*
if ($codigoFuncionarioUsuario == "940114W" || $codigoFuncionarioUsuario == "009252K" || $codigoFuncionarioUsuario == "007065Z" || $codigoFuncionarioUsuario == "975834P" || $codigoFuncionarioUsuario == "010907Z" || $codigoFuncionarioUsuario == "036001N" || $codigoFuncionarioUsuario == "036005J") $codigoPerfil = 180;
if ($codigoFuncionarioUsuario == "995762T" || $codigoFuncionarioUsuario == "007174T" || $codigoFuncionarioUsuario == "007173S" || $codigoFuncionarioUsuario == "953162X" || $codigoFuncionarioUsuario == "981445Q") $codigoPerfil = 190;
*/
echo $codigoPerfil;
...
if ($codigoPerfil == 180) {
	$descripcionPerfilUsuario	= "OPERADOR";
} elseif ($codigoPerfil == 190) {
	$descripcionPerfilUsuario	= "INGENIERO";
}
...
<div id="usuario">
	<div id="nombreUnidad">CARABINEROS DE CHILE - <?
													if ($codigoPerfil == 180) {
														echo $descripcionUnidadUsuario = "DEPTO. CONTROL DE GESTION Y SIST. DE INFORMACI0N - MESA DE AYUDA";
													} elseif ($codigoPerfil == 190) {
														echo $descripcionUnidadUsuario = "DEPTO. CONTROL DE GESTION Y SIST. DE INFORMACION - AREA INFORMATICA";
													} elseif ($codigoPerfil == 200) {
														echo $descripcionUnidadUsuario = "DEPTO. CONTROL DE GESTION Y SIST. DE INFORMACION - OFICINA DE PARTES O.P.U.";
													} else {
					...
					<li><a href="#">Solicitudes</a>
						<ul>
							<? if ($codigoPerfil == 180) { ?>
								...
								<li><a href="solicitudesAntecedentesFaltantes.php">Solicita antecedentes</a></li>
							...
							<? } else if ($codigoPerfil == 190) { ?>
								...
								<li><a href="solicitudesMesAnterior.php">Mes anterior</a></li>
