...
<body>
    ...
    <div class="backHeader">
        <marquee>
            <font face="Verdana" size="3" color="white"><strong>IMPORTANTE:</strong> EL CIERRE DE LOS REGISTROS DEL MES DE OCTUBRE 2023 SE REALIZARÁ EL DIA VIERNES 3 DE NOVIEMBRE A LAS 17:00 HRS.</font>
        </marquee>
    </div>
    <div class="content">
        <div class="links">
