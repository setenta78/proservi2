<?
	...
	$objDBAnimales->listaCaballosAgregados($unidad, $nombreBuscar, $camporOrden, $sentidoOrden, &$animales);
  ...
  echo "<root>";
 	...
 	echo "<animal>";
		...
		echo "<codigoUnidad>".$animales[$i]->getUnidad()->getCodigoUnidad()."</codigoUnidad>";
		echo "<desUnidad>".$animales[$i]->getUnidad()->getDescripcionUnidad()."</desUnidad>";
