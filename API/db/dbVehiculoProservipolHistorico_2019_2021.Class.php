...
Class dbVehiculoProservipolHistorico_2019_2021 extends ConexionDBProservipolHistorico{
	
	function serviciosVehiculooPorCodigoDeVehiculo_2019_2021($codigoVehiculo, $fechaDesde, $fechaHasta){
