...
<body onload="actualizarTamanoLista('listado');" onresize="actualizarTamanoLista('listado');">
	...
	<div style="margin-left:10px; margin-right:10px; margin-top:10px;">
		...
		<div id="subtitulo">En esta lista se encuentra el personal agregado a esta <? if ($unidadUsuario==10270) echo "Subprefectura."; else echo "Prefectura."; ?></div>
		<div style="height:45px"></div>
		<table width="100%">   
		    <tr> 
		      <td width="25%">
		      		<input type="button" name="btnNuevaReunion" id="btn100" value="AGREGAR FUNCIONARIO" disabled onClick="javascript:abrirVentana('AGREGAR FUNCIONARIO ... ', '800', '350','fichaPersonal.php','','','5','5')" disabled>
		      </td>		
