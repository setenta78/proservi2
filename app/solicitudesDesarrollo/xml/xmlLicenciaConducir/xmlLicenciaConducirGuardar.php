<?
	...
	//echo "observaciones ". $municipalObservaciones;
	...
	if ($existeLicenciaMunicipal == 0 && $municipalNumero != "") $resultado = $objDBLicenciasDeConducir->deleteLicenciaConducirMunicipal($licenciasDeConducir[0]);
	if ($existeLicenciaSemep == 0) $resultado = $objDBLicenciasDeConducir->deleteLicenciaConducirSemep($licenciasDeConducir[1]);
	
	
	if ($existeLicenciaMunicipal == 1) $resultado = $objDBLicenciasDeConducir->insertLicenciaConducirMunicipal($licenciasDeConducir[0]);
	if ($existeLicenciaSemep == 1) $resultado = $objDBLicenciasDeConducir->insertLicenciaConducirSemep($licenciasDeConducir[1]);
