...
<body onload="actualizarTamanoLista('listado');" onresize="actualizarTamanoLista('listado');">
	...
	<div style="margin-left:10px; margin-right:10px; margin-top:10px;">
		...
		<div id="subtitulo">En esta lista se encuentra el personal asignado a esta Unidad.</a></div>
		<div style="height:68px"></div>
		<table width="100%">   
		    <tr> 
		      <td width="25%">
		      		<input type="button" name="btnNuevaReunion" id="btn100" value="AGREGAR FUNCIONARIO" onClick="javascript:abrirVentana('AGREGAR FUNCIONARIO ... ', '800', '333','fichaPersonal.php','','','5','5')">
		      </td>		
