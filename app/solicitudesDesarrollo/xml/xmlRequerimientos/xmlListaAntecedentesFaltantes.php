<?
  ...
  require("../../objetos/unidad.class.php");
	...
	$objFuncionarios->listaAntecedentesFaltantes($unidad, $nombreBuscar, $escalafon, $grado, $camporOrden, $sentidoOrden, &$funcionarios);
	$cantidad = count($funcionarios);
  	...
  	echo "<root>";
   	for ($i=0; $i<$cantidad; $i++){
   		...
   		echo "<tipoMovimiento>".$funcionarios[$i]->getMovimientoCodigo()."</tipoMovimiento>";
   		echo "<seccionDepto>".$funcionarios[$i]->getSeccionDepto()."</seccionDepto>";
	 	  echo "</requerimiento>";
 	}
	echo "</root>";
 ?>