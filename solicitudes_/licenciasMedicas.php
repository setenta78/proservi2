...
<body onload="actualizarTamanoLista('listado');mensajeLicencia()" onresize="actualizarTamanoLista('listado');">
	...
	<div style="margin-left:10px; margin-right:10px; margin-top:10px;">
		...
		<table width="100%">   
		    <tr> 
		      <td width="25%">
		      		<input type="button" name="btnNuevaReunion" id="btn100" value="AGREGAR LICENCIA" onClick="javascript:abrirVentana('LICENCIA MEDICA ... ', '920', '780','fichaLicencia.php','','','5','5')">
		      </td>		
			  ...
			  <td width="20%"><input type="button" id="btn100" value="BUSQUEDA AVANZADA >>>" disabled></td>
				...
				<img src="img/licenciasmedicas.png" width="250px" height="118px" bgcolor= "#ffffff">
		    </tr>
		</table>
		...
		<div id="listado">
			...
			<table cellspacing="1" cellpadding="1" width="100%">
		        <tr> 
		          ...
		          <td id="colGrado"  class="nombreColumna" width="20%" align="center"  onmousedown="cambiaOrdenLista(this,'grado','desc','<?echo $unidadUsuario?>')"><label id="labColGrado">LICENCIA MEDICA</label></td>
		          <td id="colCargo"  class="nombreColumna" width="10%" align="center"  onmousedown="cambiaOrdenLista(this,'cargo','desc','<?echo $unidadUsuario?>')"><label id="labColCargo">FECHA INICIO REAL</label></td>		       
		          <td id="colCargo"  class="nombreColumna" width="10%" align="center"  onmousedown="cambiaOrdenLista(this,'cargo','desc','<?echo $unidadUsuario?>')"><label id="labColCargo">FECHA TERMINO REAL</label></td>		       
		          <td id="colCargo"  class="nombreColumna" width="10%" align="center"  onmousedown="cambiaOrdenLista(this,'cargo','desc','<?echo $unidadUsuario?>')"><label id="labColCargo">ARCHIVO</label></td>		          	
		          <td id="colCargo"  class="nombreColumna" width="10%" align="center"  onmousedown="cambiaOrdenLista(this,'cargo','desc','<?echo $unidadUsuario?>')"><label id="labColCargo">CONSTANCIA</label></td>
		        </tr>
