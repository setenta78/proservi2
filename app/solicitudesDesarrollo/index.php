...
<head>
	...
	<title>PROSERVIPOL - Solicitudes</title>	
...
<body>
	...
	<div class="content">
			<!--<marquee><font face="Verdana" size="3" color="red">Por motivos de caída de servidor que aloja la base de datos del sistema Proservipol V3, el cierre correspondiente al mes de <strong>Octubre de 2017</strong> ha sido reprogramado para el día  <strong>07 de Noviembre a las 15:00 Hrs.</strong>  </font></marquee>-->
			<!--<marquee><font face="Verdana" size="3" color="red">Próximo cierre correspondiente al mes de <strong>Febrero de 2018</strong> está programado para el día  <strong>07 de Marzo.</strong>  </font></marquee>-->
	<!--<marquee>Próximo cierre correspondiente al mes de <strong>Julio de 2017</strong> esta programado para el día  <strong>08 de Agosto</strong> a las 17:00 hrs. </marquee>-->
		<div id="login">		
			<form method="post" action="valida.php" id="form1" name="form1">
				<h2>ADMINISTRACIÓN DE SOLICITUDES<br/>
				</h2>
				<img alt="" height="50" src="images/pro1.fw.png" width="50" />
				<div>
					<span id="txtForm">Usuario :</span> 
					<input name="textUsuario" type="text" class="login-campos" id="textUsuario" placeholder="ingrese usuario" maxlength="10" />
				</div>
				<br/>
				<div>
					<span id="txtForm">   Clave... :</span>
					<input name="textClave" type="password" class="login-campos" id="textClave" placeholder="ingrese clave" maxlength="10"  />
				</div>
				<br/>
				<div>
