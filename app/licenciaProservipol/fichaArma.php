...
<?
	...
	$tipoUnidad	    = $_SESSION['USUARIO_TIPOUNIDAD']; //Variable agregada el 05-05-2015
	$contieneHijos  = $_SESSION['USUARIO_CONTIENEHIJOS']; //Variable agregada el 05-05-2015
	//$unidadUsuario	= 10;
?>
<html>
<head>
...
<script type="text/javascript" src="./js/seccion.js"></script><!-- Llamada agregada el 05-05-2015 -->
</head>
<body style="margin-top:10; margin-left:10; background-color:#d0d0d0" onload="javascript:leeTipoArma('selTipoArma');leeEstadosRecursos('selEstado','ARM');leeMarcaArmas('selMarca');leeSeccion('selSeccion')" scroll="no">
...
<input id="contieneHijos"  type="hidden" readonly="yes" value="<?echo $contieneHijos?>"><!-- Variable agregada el 05-05-2015 -->
<input id="tipoUnidad"  type="hidden" readonly="yes" value="<?echo $tipoUnidad?>"><!-- Variable agregada el 05-05-2015 -->
<input id="codUnidadAgregadoBaseDatos" type="hidden" readonly="yes">
<input id="desUnidadAgregadoBaseDatos" type="hidden" readonly="yes">
<input id="seccionBaseDatos" type="hidden" readonly="yes"><!-- Variable agregada el 05-05-2015 -->
...
<div id="marcoLevantado">
	...
	<div id="cuadro">
	<table cellpadding="0" cellspacing="0" width="100%">
           <tr id="filaSeccion"><!-- Agregada fila seccion mas combobox seccion el 05-05-2015 -->
