<?
  ...
  require("../../objetos/unidad.class.php");
	...
	$objFuncionarios->listaIngeniero($unidad, $nombreBuscar, $escalafon, $grado, $camporOrden, $sentidoOrden, &$funcionarios,$usuario);
	
	//echo $objFuncionarios;
	//exit;
	...
	$cantidad = count($funcionarios);
  	...
  	echo "<root>";
   	for ($i=0; $i<$cantidad; $i++){
   		...
   		echo "<codUnidad>".$funcionarios[$i]->getcodUnidad()."</codUnidad>";
