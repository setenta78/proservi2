...
<body onload="actualizarTamanoLista('listado');" onresize="actualizarTamanoLista('listado');">
	...
	<div style="margin-left:10px; margin-right:10px; margin-top:10px;">
		<div id="titulo">REQUERIMIENTOS</div>
		<div id="subtitulo">En esta lista se encuentran las solicitudes realizadas por esta Unidad</div>
		<div style="height:90px"></div>
		<table width="100%">   
		    <tr> 
		      <td width="25%">
		      		<input type="button" name="btnNuevaReunion" id="btn100" value="AGREGAR SOLICITUD" onClick="javascript:abrirVentana('AGREGAR SOLICITUD ... ', '720', '575','fichaRequerimiento.php','','','5','5')">
		      </td>		
			  <td width="15%"align="right">REQUERIMIENTO&nbsp;:&nbsp;</td>
		...
		<div id="listado">
			...
			<table cellspacing="1" cellpadding="1" width="100%">
		        <tr> 
		          ...
		          <td id="colCodigo" class="nombreColumna" width="10%" align="center"  onmousedown="cambiaOrdenLista(this,'codigo','desc','<?echo $unidadUsuario?>')"><label id="labColCodigo">REQUERIMIENTO</label></td>
		          <td id="colNombre" class="nombreColumna" width="38%" align="center"  onmousedown="cambiaOrdenLista(this,'nombre','desc','<?echo $unidadUsuario?>')"><label id="labColNombre">PROBLEMA</label></td>
		          <td id="colGrado"  class="nombreColumna" width="20%" align="center"  onmousedown="cambiaOrdenLista(this,'grado','desc','<?echo $unidadUsuario?>')"><label id="labColGrado">FECHA</label></td>
