...
<table width="100%">
<tr> 
	<td width="30%" align="right" >Codigo&nbsp;:&nbsp;</td>
	<td width="15%"><? echo $codigo; ?><input id="textCodigo" type="hidden" readonly="yes" value="<? echo $codigo; ?>" style="background-color:#E6E6E6"></td>
	<td width="15%"></td>
	<td width="40%"></td>
</tr>
<tr style="padding: 0px 0px 2px 0px">
			<td width="30%" align="right">Nombre&nbsp;:&nbsp;</td>
			<td width="60%"><? echo $nombre; ?><input id="textNombre" type="hidden" disabled="yes" value="<? echo $nombre; ?>" style="background-color:#E6E6E6"></td>
			<td width="10%"></td>
</tr>
</table>
</fieldset>
