...
AND MOVIMIENTO.FECHA_TERMINO IS NULL";
      ...
      //$implicado="995762T";
		...
		function datoUsuario($unidad,$usuario,$tipoUnidad,$vista){
					 
			if($tipoUnidad!=30 && $tipoUnidad!=160){   	   
	    $sql = "SELECT 
        ...
        ORDER BY 
         ...
         VISTA_ARBOL_UNIDADES_NACIONAL.UNI_DESCRIPCION";
         	    ...
         	    $sql = "SELECT 
              UNIDAD1.UNI_DESCRIPCION AS ZONA,
          ...
          USUARIO
           ...
           WHERE
          UNIDAD.UNI_CODIGO=".$unidad." AND USUARIO.US_LOGIN='".$usuario."'
        ";
        }                     
	    	 //echo $sql;
	...
	function datoUsuarioSolicitud($unidad,$solicitud,$usuario,$tipoUnidad,$vista){				 
		...
		if($tipoUnidad!=30 && $tipoUnidad!=160){
          ...
          USUARIO
            ...
            INNER JOIN TIPO_MOVIMIENTO ON (MOVIMIENTO.TMOV_CODIGO = TIPO_MOVIMIENTO.TMOV_CODIGO)
           WHERE
         VISTA_ARBOL_UNIDADES_NACIONAL.UNI_CODIGO=".$unidad." AND SOLICITUD.SOL_CODIGO=".$solicitud."
         AND FECHA_TERMINO IS NULL
         ORDER BY 
         VISTA_ARBOL_UNIDADES_NACIONAL.ZONA_DESCRIPCION,
         VISTA_ARBOL_UNIDADES_NACIONAL.PREFECTURA_DESCRIPCION,
         ...
         VISTA_ARBOL_UNIDADES_NACIONAL.UNI_DESCRIPCION";
          ...
          USUARIO
            ...
            INNER JOIN UNIDAD ON (USUARIO.UNI_CODIGO = UNIDAD.UNI_CODIGO)
            INNER JOIN UNIDAD UNIDAD1 ON (UNIDAD.UNI_PADRE = UNIDAD1.UNI_CODIGO)
            INNER JOIN SOLICITUD ON (UNIDAD.UNI_CODIGO = SOLICITUD.UNI_CODIGO)
            INNER JOIN MOVIMIENTO ON (SOLICITUD.SOL_CODIGO = MOVIMIENTO.SOL_CODIGO)
            INNER JOIN PROBLEMA ON (SOLICITUD.PROB_CODIGO = PROBLEMA.PROB_CODIGO)
            INNER JOIN SUBPROBLEMA ON (SOLICITUD.SUBP_CODIGO = SUBPROBLEMA.SUBP_CODIGO)
            INNER JOIN TIPO_MOVIMIENTO ON (MOVIMIENTO.TMOV_CODIGO = TIPO_MOVIMIENTO.TMOV_CODIGO)
           WHERE
         UNIDAD.UNI_CODIGO=".$unidad." AND SOLICITUD.SOL_CODIGO=".$solicitud." 
         AND FECHA_TERMINO IS NULL";
