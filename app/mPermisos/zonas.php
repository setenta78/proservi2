...
<title>CONSULTAS PROSERVIPOL - ASIGNACIONES PENDIENTES</title>
<script src="js/autocompletar2.js" type="text/javascript" language="javascript"></script>
...
<legend style="font-weight:bold;font-family:Verdana;font-size: 12px;color:#00000;">BUSQUEDA POR ZONAS</legend>
<br>
<table border="0">
<tr>
<td>&nbsp;Unidad</td>
<td>:&nbsp;<input type="text" id="input" name="texto" class="campos" size="40" style='text-transform:uppercase;' onKeyUp="autocompletar('lista',this.value);" /><input type="hidden" size="40" id="input2" name="texto2"/></td>
<td>&nbsp;Mes</td>
<td>&nbsp;:<select name="mes">
