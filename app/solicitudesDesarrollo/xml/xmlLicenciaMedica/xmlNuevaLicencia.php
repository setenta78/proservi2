...
//	$fechaIDate = new Time($fechaReal);
//	$fechaFDate = new Time($fechaTermino);
	
//	$newDias = $fechaIDate->diff($fechaFDate);
//	$newDias = $newDias->format("%d");
...
//	echo "Dato7";
 ...
 /* $fecha_termino = mktime ( 0, 0, 0, date ("$partesfi[1]"), date ("$partesfi[0]") + $suma_dias, date ("$partesfi[2]") );
  ...
  //$servicio = new servicio;
	...
	//$funcionario->setFechaTerminoInicial($terminoLicencia);
	...
	$funcionario->setCodigoSelime($selime);
