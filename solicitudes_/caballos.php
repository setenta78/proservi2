...
<body onload="actualizarTamanoLista('listado');" onresize="actualizarTamanoLista('listado');">
	...
	<div style="margin-left:10px; margin-right:10px; margin-top:10px;">
		...
		<div id="subtitulo">En esta lista se encuentran los Animales asignados a esta Unidad.</div>
		<div style="height:90px"></div>
		<table width="100%">   
		    <tr> 
		      <td width="25%">
		      		<input type="button" name="btnNuevaReunion" id="btn100" value="AGREGAR ANIMAL" onClick="javascript:abrirVentana('AGREGAR ANIMAL ... ', '800', '360','fichaCaballo.php','','','5','5')">
		      </td>		
			  <td width="35%"align="right">NOMBRE&nbsp;:&nbsp;</td>
			  <td width="10%"><input id="textBuscar" type="text"></td>
			  <td width="10%"><input type="button" id="btn100" value="BUSCAR" onClick="leeCaballos('<?echo $unidadUsuario?>')"></td>
		...
		<div id="listado">
			...
			<table cellspacing="1" cellpadding="1" width="100%">
		        <tr> 
		          ...
		          <td id="nombreColumna" width="23%" align="center">TIPO</td>
		          <td id="nombreColumna" width="23%" align="center">NOMBRE DEL ANIMAL</td>
		          <td id="nombreColumna" width="15%" align="center">RAZA/COLOR</td>
		          <td id="nombreColumna" width="15%" align="center">NRO. BCU</td>
...
<?
	echo "<script>";
	echo "leeCaballos('".$unidadUsuario."');";
	echo "leePerros('".$unidadUsuario."');";
	echo "</script>";
?>