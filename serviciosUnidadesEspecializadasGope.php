...
<body onload="actualizarTamanoLista('listado');" onresize="actualizarTamanoLista('listado');">
    ...
    <input id="perfil"  type="hidden" readonly="yes" value="<?echo $codigoPerfil?>">
     <input id="uniGope1"  type="hidden" readonly="yes" value="<?echo $unidaUsuario?>">
	...
	<div style="margin-left:10px; margin-right:10px; margin-top:10px;">
		...
		<table width="100%">   
		  <tr> 
		    <td width="25%"><input type="button" name="btnNuevaReunion" id="btnNuevaReunion" value="NUEVO SERVICIO" <? if(!$permisoRegistrar) echo 'disabled'; else echo 'enabled'; ?> onClick="javascript:abrirVentana('NUEVO SERVICIO ... ', '970', '550','fichaServicioEspecializadasGope.php', '','','5','5')"></td>
			<td width="20%"></td>
			<td width="28%"align="right">FECHA&nbsp;:&nbsp;</td>
			<td width="15%"><input type="hidden" value="<?echo $unidadBloqueada?>" name="textUnidadBloqueada" id="textUnidadBloqueada"/><input type="hidden" value="<?echo $fechaLimite?>" name="textFechaLimite" id="textFechaLimite"/><input id="textBuscar" type="text" readonly="yes" value="<?echo date("d-m-Y");?>"></td>
