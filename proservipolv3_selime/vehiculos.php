...
<body onload="actualizarTamanoLista('listado');" onresize="actualizarTamanoLista('listado');">
	...
	<div style="margin-left:10px; margin-right:10px; margin-top:10px;">
		...
		<table width="100%">   
		    <tr> 
		      <td width="25%">
		      		<input type="button" name="btnNuevaReunion" id="btn100" value="AGREGAR VEHICULO" onClick="javascript:abrirVentana('AGREGAR VEHICULO ... ', '800', '375','fichaVehiculo.php','','','5','5')">
		      </td>		
