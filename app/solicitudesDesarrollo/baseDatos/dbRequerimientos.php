...
class dbRequerimiento extends Conexion
{
  ...
  function listaRequerimientoCerradas($Unidad, $nombreBucar, $escalafon, $grado, $NombreCampo, $TipoOrden, $funcionarios)
  {
    ...
    $sql = "SELECT 
             ...
             WHERE
              ...
              AND VISIBLE=1 AND SOL_FECHA >= '20241201'
              ORDER BY
    ...
    $sql = "SELECT 
            ...
            INNER JOIN GRADO ON (FUNCIONARIO.ESC_CODIGO = GRADO.ESC_CODIGO)
             ...
             WHERE
              ...
              AND FECHA_TERMINO IS NULL 
              AND VISIBLE=1 AND SOLICITUD.SOL_FECHA >= '20241201'
              ORDER BY
              SOLICITUD.SOL_FECHA DESC
              ";
  ...
  function listaTotalRequerimiento($Unidad, $nombreBucar, $escalafon, $grado, $NombreCampo, $TipoOrden, $funcionarios)
  {
    ...
    $sql = "SELECT  
            ...
            INNER JOIN GRADO ON (FUNCIONARIO.ESC_CODIGO = GRADO.ESC_CODIGO)
             AND (FUNCIONARIO.GRA_CODIGO = GRADO.GRA_CODIGO)
                WHERE
                (TMOV_DESCRIPCION = 'OFICIALIZADO' OR TMOV_DESCRIPCION = 'EN TRAMITE: ENVIA ANTECEDENTES FALTANTES') AND  SOLICITUD.SOL_FECHA >= '20241201'
                AND FECHA_TERMINO IS NULL
  ...
  //ESTA ES LA QUE SE MUETSRA EN VISTA INGENIEROS
    ...
    $sql = "SELECT  
            ...
            INNER JOIN GRADO ON (FUNCIONARIO.ESC_CODIGO = GRADO.ESC_CODIGO)
             ...
             TIPO_MOVIMIENTO.TMOV_CODIGO IN(70,80)
              AND SOLICITUD.SOL_FECHA >= '20241201'
  ...
  function listaIngeniero($Unidad, $nombreBucar, $escalafon, $grado, $NombreCampo, $TipoOrden, $funcionarios, $usuario)
  {
    ...
    $sql = "SELECT  
             ...
             AND (FUNCIONARIO.GRA_CODIGO = GRADO.GRA_CODIGO)
                ...
                AND SOLICITUD.SOL_FECHA >= '20241201' AND MOVIMIENTO.FECHA_TERMINO IS NULL
    ...
    $sql = "SELECT  
            ...
            INNER JOIN GRADO ON (FUNCIONARIO.ESC_CODIGO = GRADO.ESC_CODIGO)
             AND (FUNCIONARIO.GRA_CODIGO = GRADO.GRA_CODIGO)
                ...
                AND FECHA_TERMINO IS NULL AND SOL_FECHA >= '20241201'
                 ORDER BY
            SOLICITUD.SOL_FECHA DESC,
          SOLICITUD.UNI_CODIGO
           ";
