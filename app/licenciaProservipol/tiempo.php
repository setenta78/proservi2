...
//Comparamos el tiempo transcurrido, si pasaron 15 minutos o más  
//if($tiempo_transcurrido >= 5000) { 

 //MODIFICA BITACORA USUARIOS
//  $objDBUsuarios = new dbUsuarios;
//  $objDBUsuarios->modificaBitacoraUsuario($codigoFuncionarioUsuario,$codigoUnidadUsuario,$fecha_hra_inicio,$hora_actual,$perfil1,$evento);
//FIN
