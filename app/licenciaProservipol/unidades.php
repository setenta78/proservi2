...
<script type="text/javascript" src="./js/crearArbolFiscalizador.js"> </script>
...
<body onload="actualizarTamanoLista('listado');" onresize="actualizarTamanoLista('listado');">
	...
	<div style="margin-left:10px; margin-right:10px; margin-top:10px;">
		...
		<div id="subtitulo">En esta lista se encuentran las Unidades que puede administrar.</div>
