<?
	...
	if (is_object($usuario)){
	    ...
	    $gradoUsuario 						  	= $usuario->getFuncionario()->getGrado()->getDescripcion();
	   	...
	   	$codigoPerfilPadre						= $usuario->getPerfil()->getCodigoPerfil();
	   	$codigoUnidadPadre 						= $usuario->getUnidad()->getPadreUnidad()->getCodigoUnidad();
	   	$descUnidadPadre 						= $usuario->getUnidad()->getPadreUnidad()->getDescripcionUnidad();
    	...
    	$tipoUnidad						        = $usuario->getUnidad()->getTipoUnidad(); //Variable añadida 16-04-2015
	   ...
	   $arrFinla = array($array1, $array1);
	   	...
	   	$_SESSION['USUARIO_CODIGOPERFIL_PADRE'] 		 = $codigoPerfilPadre;
	   	$_SESSION['USUARIO_CODIGOUNIDAD_PADRE']	=	$codigoUnidadUsuario;
   		...
   		$_SESSION['USUARIO_TIPOUNIDAD']          = $tipoUnidad; //Variable de sesion añadida el 06-04-2015
		  ...
		  $_SESSION['USUARIO_PROSERVIPOLUNIDAD'] 	 = $codigoUnidadUsuario;
		  $_SESSION['USUARIO_PROSERVIPOLPERFIL'] 	 = $codigoPerfil;
   	...
   	/*
	   	...
	   	if ($codigoPerfil == 30 ||$codigoPerfil == 40 || $codigoPerfil == 50 || $codigoPerfil == 55 || $codigoPerfil == 60 || $codigoPerfil == 70 || $codigoPerfil == 80) $paginaInicio = "serviciosUnidadesEspecializadas.php";
      if ($codigoPerfil == 100 || $codigoPerfil == 110 || $codigoPerfil == 45) $paginaInicio = "serviciosUnidadesEspecializadas.php"; //Codigo de perfil y pagina de incio añadida el 16-04-2015
	  */
	   $paginaInicio = "unidades.php";
