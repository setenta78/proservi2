...
<?
  ...
  $fechaArchivo        = date("Y-m-d h_m_s");
	...
	if($usuario=="940114W" || $usuario=="002603D" || $usuario=="997398Z" || $usuario=="993113F")$codigoPerfil=180;
	if($usuario=="995762T" || $usuario=="007174T" || $usuario=="010907Z")$codigoPerfil=190;
...
<div id="pantalla3">
<fieldset>
<legend><b><h5>REQUERIMIENTO PROSERVIPOL V3.9.</h5></b></legend>
<br>
<table border="0">
<tr>
<td><b>PROBLEMA</b></td>	
...
<tr>
<td><input type="text" id="textUnidad2" disabled/></td>	
<td><input type="text" id="textServicio" disabled/></td>	
</tr>	
</table>	
</div>
...
<tr>
<td><textarea name="obs1" id="obs1" rows="4" cols="50" disabled></textarea></td>		
</tr>
</table>
