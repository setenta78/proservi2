...
function leeCargos(nombreObjeto){
    var tipoUnidad = document.getElementById("tipoUnidad").value; //Variable agregada el 30-04-2015
	cargaCargos = 0;
	...
	objHttpXMLCargo.send(encodeURI("tipoUnidad="+tipoUnidad)); //Parametro Agregado el 30-04-2015
