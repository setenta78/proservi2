...
<div class='barra_superior'>
    ...
    <?php
    echo "<b>MODULO USUARIOS PROSERVIPOL V3.0 - RRCC<br><br>".strtoupper($_SESSION["session_nombre"])." (".strtoupper($_SESSION["session_login"]).") (".strtoupper($_SESSION["session_atrib"]).")</b>";
    ?>
</div>
