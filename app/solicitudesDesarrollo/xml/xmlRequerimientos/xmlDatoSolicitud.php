<?
  ...
  $unidad = $_POST['unidad'];
	...
	$objFuncionarios->datoSolicitud($unidad,$codigo,&$solicitudes);
	$cantidad = count($solicitudes);
  	if ($cantidad > 0){
	  	...
	  	echo "<root>"; 
   		   ...
   		   echo "<secciones>".$solicitudes->getSecciones()."</secciones>";
   		   echo "<nombreUnidad>".$solicitudes->getNombreUnidad()."</nombreUnidad>";
   		   echo "<passUsuario>".$solicitudes->getPassUsuario()."</passUsuario>";
         echo "</solicitud>";
         echo "</root>";
	}else{
		     echo "VACIO";
