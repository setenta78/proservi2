...
require_once("class/class_historicos.php");
...
<head>
<meta charset="utf-8">
<title>CONSULTAS SERVICIOS HISTORICOS PROSERVIPOL</title>
...
echo "<table border='0'>";
echo "<tr>";
echo "<td><b>"." Bienvenid@"."</b>".":&nbsp;".$datos."</td>";
echo "<td></td>";
echo "</tr>";
echo "<tr>";
...
echo "</tr>";
echo "<tr>";
echo "<td><b>Volver a Registros Actuales:&nbsp;<a href='servicios.php'><img src='img/Actions-go-previous-icon.png' border='0' align='middle' alt='Volver'/></a></b></td>";
echo "<td></td>";
echo "</tr>";
echo "</table>";
...
<legend style="font-weight:bold;font-family:Verdana;font-size: 12px;color:#00000;">CONSULTAS HISTORICOS DIPECAR&nbsp;<img src="img/Search-icon.png" height="" width="" border="0" align="middle"></legend>
<br>
<table border="0">
<tr>
<td>&nbsp;C&Oacute;DIGO DE FUNCIONARIO:</td>
<td><input type="text" id="texto2" name="texto2" class="campos" size="7" style="text-transform:uppercase;" onclick="limpia(this);"/></td>
<td>&nbsp;FECHA DESDE:</td>
...
<br/>
&nbsp;&nbsp;<input type="button" id="btn"  value="CONSULTAR" title="CONSULTAR" onClick="consultarServicio2();"/><input type="hidden" name="grabar" value="si">
<!--<div id="reloj"><img src="images/preloder.gif" /></div>-->
</fieldset>
</form>
</div>
<div id="contenidoPagina2"></div>
<br>
<div id="contenedor">
