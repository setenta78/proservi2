...
<body onload="actualizarTamanoLista('listado');" onresize="actualizarTamanoLista('listado');">
	...
	<div style="margin-left:10px; margin-right:10px; margin-top:10px;">
		...
		<div id="subtitulo">En esta lista se encuentra el personal asignado a esta Unidad</div>
		<div style="height:45px"></div>
		<table width="100%">   
		    <tr> 
		      <td width="25%">
		      		<input type="button" name="btnNuevaReunion" id="btn100" value="AGREGAR FUNCIONARIO" onClick="javascript:abrirVentana('AGREGAR FUNCIONARIO ... ', '800', '375','fichaPersonal.php','','','5','5')">	
		      </td>		
		     <td><a href="./xml/xmlServicios/excelListaServiciosPorFuncionario2.php?unidad=<? echo $unidadUsuario ?>"><img src="img/microsoft-excel.png" alt="Descargar Excel" width="30" height="32" border="0"></a> </td>
			  ...
			  <td width="10%"><input type="button" id="btn100" value="REVISION BASE DE DATOS P.7." onclick="location.href='personalComparar.php';"></td>
		...
		<div id="listado">
			...
			<table cellspacing="1" cellpadding="1" width="100%">
		        <tr> 
		          ...
		          <td id="colGrado"  class="nombreColumna" width="20%" align="center"  onmousedown="cambiaOrdenLista(this,'grado','desc','<?echo $unidadUsuario?>')"><label id="labColGrado">GRADO</label></td>
		          <td id="colCargo"  class="nombreColumna" width="28%" align="center"  onmousedown="cambiaOrdenLista(this,'cargo','desc','<?echo $unidadUsuario?>')"><label id="labColCargo">CARGO</label></td>
		        </tr>
		     </table>
		    </div>
