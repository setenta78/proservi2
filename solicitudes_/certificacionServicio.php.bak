...
<div style="margin-left:10px; margin-right:10px; margin-top:10px;">
      ...
      <tr>
        ...
        <td align="right" width="5%">UNIDAD&nbsp;:&nbsp;</td>
 
        <td width="30%">
            <select class="campoSelect" id="selUnidad" name="selUnidad">
        ...
        <input class="Boton_100" type="button" id="btnCargaDatos" value="CONSULTAR" onclick="verificaIngresoDatos(selMes.value,selAnno.value,selUnidad.value);">
...
if($codigoPerfil==70 or $codigoPerfil==30){
	echo "<script>";
	echo "buscaUnidades('".$unidadUsuario."');";
	echo "</script>";
} else if($codigoPerfil==80 or $codigoPerfil==10 or $codigoPerfil==20 or $codigoPerfil==45 or $codigoPerfil==120){
				echo "<script>";
