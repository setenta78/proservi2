...
function setDiferenciaDias($diferenciaDias){
	...
	function setFechaArchivo($fechaArchivo){
		...
		function setMovimientoCodigo($movimientoCodigo){
		$this->movimientoCodigo = $movimientoCodigo;
	}	
	
	function setSeccionDepto($seccionDepto){
		$this->seccionDepto = $seccionDepto;
	}	
...
function getIdentificadores(){
 ...
 function getDiferenciaDias(){
	...
	function getMovimientoCodigo(){
		return $this->movimientoCodigo;
	}
	
	function getSeccionDepto(){
		return $this->seccionDepto;
	}
