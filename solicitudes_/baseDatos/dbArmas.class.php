...
{			
		...
		function insertEstadoArma($arma, $fechaNuevoEstado){
			...
			$sql = "INSERT INTO ESTADO_ARMA (EST_CODIGO, UNI_CODIGO, ARM_CODIGO, FECHA_DESDE, UNI_AGREGADO) 
					VALUES (".$arma->getEstado()->getCodigo().",".$arma->getUnidad()->getCodigoUnidad().",".$arma->getCodigo().",'".$fechaNuevoEstado."',".$unidadAgregadoGuardar.")";
