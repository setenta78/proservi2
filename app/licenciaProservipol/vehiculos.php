...
<body onload="actualizarTamanoLista('listado');" onresize="actualizarTamanoLista('listado');">
	...
	<div style="margin-left:10px; margin-right:10px; margin-top:10px;">
		...
		<table width="100%">   
		    <tr> 
		      <td width="25%">
		      		<input type="button" name="btnNuevaReunion" id="btn100" value="AGREGAR VEHICULO" onClick="javascript:abrirVentana('AGREGAR VEHICULO ... ', '800', '395','fichaVehiculo.php','','','5','5')">
		      </td>		
		      <td><a href="./xml/xmlServicios/excelListaServiciosPorFuncionario3.php?unidad=<? echo $unidadUsuario ?>"><img src="img/microsoft-excel.png" alt="Descargar Excel" width="30" height="32" border="0"></a> </td>
		...
		<div id="listado">
			...
			<table cellspacing="1" cellpadding="1" width="100%">
		        <tr> 
		          ...
		          <td id="nombreColumna" width="23%" align="center">MARCA/MODELO</td>
		          <td id="nombreColumna" width="15%" align="center">PATENTE</td>
