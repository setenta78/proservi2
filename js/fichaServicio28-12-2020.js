...
function validaMedioVigilancia(){
	var tipoUnidad   = document.getElementById('tipoUnidad').value;
	var uniGope   = document.getElementById('unidadUsuario').value;
	var uniUsuario= document.getElementById('unidadUsuario').value;//VARIABLE AGREGADA EL 01 DE JULIO
	//alert(tipoUnidad);
  //alert(uniGope);
  
  //alert('uniUsuario :'+uniUsuario);
...
//CONTROL AGREGADO EL 01 DE JULIO	S
//if(uniUsuario != 2430){
//CONTROL AGREGADO EL 20 DE SEPTIEMBE	2020
 if(uniUsuario == 1){
  var codigoVehiculoPaso = document.getElementById('vehiculosServicio').value;
...
//CONTROL AGREGADO EL 01 DE JULIO	
//if(uniUsuario != 2465 && uniUsuario != 2475 && uniUsuario != 11920 && uniUsuario != 2485 && uniUsuario != 2575 && uniUsuario != 2890 && uniUsuario != 2585 && uniUsuario != 2880){	
//CONTROL AGREGAD0 EL 02 DE SEPTIEMBRE 2020
	if(uniUsuario == 1){	
		var codigoVehiculoPaso = document.getElementById('vehiculosServicio').value;
