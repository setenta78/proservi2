...
<script type="text/javascript" src="./js/autocompletar.js?v=1.3"> </script>
<script type="text/javascript" src="./js/rectificarFechas.js?v=1.3"> </script>
<script type="text/javascript" src="./js/creaObjeto.js?v=1.3"></script>
...
<legend style="font-weight:bold;font-family:Verdana;font-size: 12px;color:#00000;">BUSCAR VEHICULO</legend>
<br>
<table border="0">
<tr>
<td>&nbsp;Patente del Vehiculo </td>
<td>:&nbsp;<input type="text" id="textPatente" name="texto" class="campos" size="10" value="" maxlength="7" onkeyup="autocompletar('lista','listaFechas',this.value);" /></td>
</tr>
</table>
</fieldset>
