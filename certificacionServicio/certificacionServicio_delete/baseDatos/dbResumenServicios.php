...
include("../../inc/configV4.inc.php");
	...
	$sql1 = "SELECT
					...
					AND CARGO_FUNCIONARIO.CAR_CODIGO IN (3000, 3001, 3002, 3003, 3004, 3005, 3006, 3100, 8520)
...
echo "<div class='linea'></div>";
	...
	$sql1 = "(SELECT
						...
						WHERE
							...
							AND ((CARGO_FUNCIONARIO.FECHA_DESDE <= '".$fecha."' AND CARGO_FUNCIONARIO.FECHA_HASTA > '".$fecha."') 
							OR (CARGO_FUNCIONARIO.FECHA_DESDE <= '".$fecha."' AND CARGO_FUNCIONARIO.FECHA_HASTA IS NULL))
						AND CARGO_FUNCIONARIO.CAR_CODIGO NOT IN (1000, 2000, 3000, 3100, 3001, 3002, 3003, 3004, 3005, 4000, 4100, 5000, 6000, 7000, 7010, 6000, 7000, 8400, 3500, 3006, 8520)
	...
	$sql1 = "SELECT
					...
					AND CARGO_FUNCIONARIO.CAR_CODIGO NOT IN (3000, 3100, 3001, 3002, 3003, 3004, 3005, 4000, 5000, 6000, 7010, 8400, 3006, 8520)					
	...
	while ($myrow1 = mysql_fetch_array($result1)){
		...
		if($myrow1[TSERV_CODIGO]==580&&$myrow1[UNI_ESPECIALIDAD]!=130){
			$ausenciasNoValidas = $ausenciasNoValidas + 1;
		  $funcionariosConProblemas = $funcionariosConProblemas . utf8_encode($myrow1[FUN_APELLIDOPATERNO])." ".utf8_encode($myrow1[FUN_APELLIDOMATERNO]).", ".utf8_encode($myrow1[FUN_NOMBRE])." - ".$myrow1[GRA_DESCRIPCION]. " (".$myrow1[FUN_CODIGO].")\n";
		}
