...
<table width="105%">
<tr> 
	  <td width="15%"><input name="btnDejarDisponible" type="button" id="btn100" value="TRASLADO" disabled></td>
	  <td width="15%"><input name="btnRetiro" type="button" id="btn100" value="RETIRO" disabled></td>
	  <td width="15%"><input name="btnBaja" type="button" id="btn100" value="BAJA" disabled></td>
   	  <td width="15%">&nbsp;</td>
      <td width="20%"><input name="btnGuardarOrganizacion" type="button" id="btn100" value="GUARDAR" disabled></td>
