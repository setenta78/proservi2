...
class Trabajo
{
	...
	//print_r($_POST);
        $sql="SELECT 
  UNIDAD.UNI_DESCRIPCION AS UNIDAD_CARGO_ORIGEN,
...
WHERE
  CARGO_FUNCIONARIO.FUN_CODIGO='".$_POST["texto2"]."'
  ORDER BY
  CARGO_FUNCIONARIO.CORRELATIVO_CARGOFUNCIONARIO ASC,
 ...
 //echo $sql;
	// verificamos que no haya error 
	   ...
	   echo "";
        exit();
         ...
         echo "<td>CARGO</td>";
         echo "<td align='middle'>UNIDAD AGREGADO</td>";
         echo "</tr>";
    ...
    //obtenemos los datos resultado de la consulta 
        ...
        echo "<td>".$i."</td>";
        echo "<td>".$row["UNIDAD_CARGO_ORIGEN"]."</td>";
        ...
        echo "<td>".$row["UNIDAD_AGREGADO"]."</td>";
        echo "</tr>";
	    }  
	    echo "</table>";
		echo "<br>";
