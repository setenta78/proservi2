...
{			
    ...
    //Agregados campos: ESTADO_VEHICULO.SEC_CODIGO, TIPO_SECCION.SEC_DESCRIPCION
    // Join agregado: LEFT OUTER JOIN TIPO_SECCION ON (TIPO_SECCION.SEC_CODIGO = ESTADO_VEHICULO.SEC_CODIGO)
		function listaTotalVehiculos($unidad, $vehiculoBuscar, $tipoVehiculo, $NombreCampo, $TipoOrden, $tipoEstado, $vehiculos){
			...
			while( $myrow = mysql_fetch_array($result) )  {
                ...
                $seccion = new seccion; //Instancia añadida el 05-05-2015
				...
				/* Agregados */
				function listaTotalVehiculosAgregados($unidad, $vehiculoBuscar, $tipoVehiculo, $NombreCampo, $TipoOrden, $tipoEstado, $vehiculos){
			...
			$sql = "SELECT 
					  ...
					  PROCEDENCIA_RECURSO.PREC_DESCRIPCION,
					  VEHICULO.UNI_CODIGO,
					  ESTADO_VEHICULO.UNI_CODIGO AS Cod_Origen,
		...
		//Funcion modificada el 05-05-2015
        //Campos agregados:   ESTADO_VEHICULO.SEC_CODIGO,TIPO_SECCION.SEC_DESCRIPCION
        //Join agregado: LEFT OUTER JOIN TIPO_SECCION ON (TIPO_SECCION.SEC_CODIGO = ESTADO_VEHICULO.SEC_CODIGO)
        ...
        $seccion = new seccion; //Instancia agregada el 05-05-2015
				$seccion->setCodigo(STRTOUPPER($myrow["SEC_CODIGO"]));
				$seccion->setDescripcion(STRTOUPPER($myrow["SEC_DESCRIPCION"]));
		...
		function insertEstadoVehiculo($vehiculo, $fechaNuevoEstado){
			...
			$sql = "INSERT INTO ESTADO_VEHICULO (VEH_CODIGO, UNI_CODIGO, EST_CODIGO, FECHA_DESDE, EST_DOCUMENTO, UNI_AGREGADO, EST_LUGARREPARACION, SEC_CODIGO)
					VALUES (".$vehiculo->getCodigoVehiculo().",".$vehiculo->getUnidad()->getCodigoUnidad().",".$vehiculo->getEstadoVehiculo()->getCodigo().",'".$fechaNuevoEstado."','".$vehiculo->getDocumentoEstado()."',".$unidadAgregadoGuardar.",".$lugarDeRepacionGuardar.",".$seccionGuardar.")";
