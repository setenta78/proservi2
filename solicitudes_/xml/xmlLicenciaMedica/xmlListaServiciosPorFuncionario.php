<?
	...
	if($fecha1==$fechaTR) $fecha1 = $fechaIR;
	...
	$objServicios->listaServiciosPorFuncionario2($funcionario, $fechaBuscar1, $fechaBuscar2, $servicio, &$servicios);
	
	$cantidad = count($servicios)-1;
	
	if($fecha1==$fechaIR)$cantidad++;
