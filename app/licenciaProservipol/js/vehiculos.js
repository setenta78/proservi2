		...
		{       
			...
			if (objHttpXMLVehiculos.responseText != "VACIO"){
				...
				for(i=0;i<xml.getElementsByTagName('vehiculo').length;i++){
                    ...
                    seccion           = xml.getElementsByTagName('seccion')[i].text; //Tag agregado el 05-05-2015
...
function leeDatosVehiculo(codigoVehiculo, bcuVehiculo, tipo){
	...
	objHttpXMLVehiculos.onreadystatechange=function()
	{
		...
		{       
   	    ...
   	    var seccion  	          = ""; //Variable agregada el 05-05-2015
        var descSeccion  	      = ""; //Variable agregada el 05-05-2015
        ...
        var validaAnno="";
          ...
          seccion 		        = xml.getElementsByTagName('seccion')[i].text; //Tag agregado el 05-05-2015
          descSeccion 		    = xml.getElementsByTagName('descSeccion')[i].text; //Tag agregado el 05-05-2015
          ...
          validaAnno = xml.getElementsByTagName('validaAnno')[i].text;
				  ...
				  document.getElementById("validaAnnoOculto").value 	 	= validaAnno;
					...
					var valoresAsignar = "'" + procedencia + "','" + tipoVehiculo + "','" + marca + "','" + modelo + "','" + estado + "','" + codigoLugarReparacion + "','" + codigoFallaVehiculo + "','" + seccion + "'," + habilitarBotones;    
...
//Funcion modificada el 05-05-2015
//Variable agregada: seccion
function asignaValores(procedencia,tipoVehiculo,marca,modelo,estado, codigoLugarReparacion, codigoFallaVehiculo, seccion, habilitarBotones){
...
function actualizarVehiculo(codigoVehiculo){
	...
	parametros += "&tipoVehiculo="+tipoVehiculo+"&marca="+marca+"&modelo="+modelo+"&seccion="+seccion;
	...
	parametros += "&lugarReparacion="+lugarReparacion+"&anno="+anno+"&valida="+valida+"&validaOculto="+validaOculto+"&fallaVehiculo="+fallaVehiculo;
	//alert(parametros);
	//alert(fechaNuevoEstado);
	var objHttpXMLVehiculos = new AJAXCrearObjeto();
...
function nuevoVehiculo(){
	...
	parametros += "&lugarReparacion="+lugarReparacion+"&seccion="+seccion+"&anno="+anno+"&valida="+valida;
...
//	}
	...
	alert("DEBE VALIDAR EL AÑO DE FABRICACION DEL VEHICULO ...... 	     ");
	 ...
	 if (annoFabricacion > 2017) {
		alert("EL AÑO DEBE SER MENOR O IGUAL A 2017 ...... 	     ");
		document.getElementById("textAnnoFab").focus();
		return false;
	}
