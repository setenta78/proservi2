...
<body onload="actualizarTamanoLista('listado');" onresize="actualizarTamanoLista('listado');">
	...
	<div style="margin-left:10px; margin-right:10px; margin-top:10px;">
		...
		<div id="subtitulo">En esta lista se encuentran los SIMCCAR asignados esta Unidad</div>
		<div style="height:90px"></div>
		<table width="100%">   
		    <tr> 
		      <td width="25%">
		      		<input type="button" name="btnNuevaReunion" id="btn100" value="AGREGAR SIMCCAR" onClick="javascript:abrirVentana('AGREGAR SIMCCAR ... ', '790', '340','fichaSimccar.php','','','5','5')">
		      </td>		
