...
<body onload="actualizarTamanoLista('listado');" onresize="actualizarTamanoLista('listado');">
	...
	<div style="margin-left:10px; margin-right:10px; margin-top:10px;">
		...
		<table width="100%">   
		    <tr> 
		      <td width="25%">
		      		<input type="button" name="btnNuevaReunion" id="btn100" value="AGREGAR ANIMAL" disabled onClick="javascript:abrirVentana('AGREGAR ANIMAL ... ', '800', '350','fichaCaballo.php','','','5','5')">
		      </td>		
		...
		<div id="listado">
			...
			<table cellspacing="1" cellpadding="1" width="100%">
		        <tr> 
		          ...
		          <td id="nombreColumna" width="23%" align="center">RAZA/COLOR</td>
		          <td id="nombreColumna" width="15%" align="center">TIPO</td>
...
<?
	echo "<script>";
	echo "leeCaballosAgregados('".$unidadUsuario."');";
	echo "</script>";
?>