...
var pathToImages = 'calendario/images/';	// Relative to your HTML file
...
function displayCalendar(inputField,format,buttonObj,offSetTop,offSetLeft,displayTime,timeInput)
{
	...
	calendar_offsetLeft = offSetLeft;
