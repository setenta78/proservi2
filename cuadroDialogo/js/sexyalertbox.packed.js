...
var SexyAlertBox = new Class({
  ...
  preloadImages: function() {
    var img = new Array(3);
    img[0] = new Image(); img[0].src = "/systema/web/des-proservipol/cuadroDialogo/img/bg-box-top.png";
    img[1] = new Image(); img[1].src = "/systema/web/des-proservipol/cuadroDialogo/img/bg-box-body.png";
    img[2] = new Image(); img[2].src = "/systema/web/des-proservipol/cuadroDialogo/img/bg-box-bottom.png";
  },
