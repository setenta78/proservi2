...
if(codUnidadFuncionario == "")
{
    ...
    document.getElementById("selTipoUsuarioPROSERVIPOL").options[1] = new Option('FISCALIZADOR ZONA','100',"","");
    document.getElementById("selTipoUsuarioPROSERVIPOL").options[1] = new Option('FISCALIZADOR PREF.','100',"","");
    document.getElementById("selTipoUsuarioPROSERVIPOL").options[2] = new Option('FISCALIZADOR EXT.','100',"","");
...
else
{
  ...
  if(tipoUnidadFuncionario == 50)
  {
      ...
      document.getElementById("selTipoUsuarioPROSERVIPOL").options[4] = new Option('VALIDADOR','80',"","");
   ...
   if(tipoUnidadFuncionario == "30" || tipoUnidadFuncionario == "120")
  {
    ...
    document.getElementById("selTipoUsuarioPROSERVIPOL").options[1] = new Option('PREFECTURA TITULAR','10',"","");
    document.getElementById("selTipoUsuarioPROSERVIPOL").options[2] = new Option('SUPLENTE','20',"","");
    document.getElementById("selTipoUsuarioPROSERVIPOL").options[3] = new Option('VALIDADOR (PREFECTURA)','80',"","");
    document.getElementById("selTipoUsuarioPROSERVIPOL").options[4] = new Option('FISCALIZADOR (PREFECTURA)','100',"","");
  }
   ...
   if(tipoUnidadFuncionario == "135" )
  {
    ...
    document.getElementById("selTipoUsuarioPROSERVIPOL").options[1] = new Option('ESUCAR TITULAR','10',"","");
    document.getElementById("selTipoUsuarioPROSERVIPOL").options[2] = new Option('ESUCAR SUPLENTE','10',"","");
    document.getElementById("selTipoUsuarioPROSERVIPOL").options[3] = new Option('VALIDADOR (ESUCAR)','80',"","");
  }

   if(tipoUnidadFuncionario == "160" )
  {
    document.getElementById("selTipoUsuarioPROSERVIPOL").options[0] = new Option('SELECCIONAR ...','0',"","");
    //document.getElementById("selTipoUsuarioPROSERVIPOL").options[1] = new Option('PREFECTURA TITULAR','45',"","");
    document.getElementById("selTipoUsuarioPROSERVIPOL").options[1] = new Option('TITULAR','10',"","");
    document.getElementById("selTipoUsuarioPROSERVIPOL").options[2] = new Option('SUPLENTE','20',"","");
    document.getElementById("selTipoUsuarioPROSERVIPOL").options[3] = new Option('VALIDADOR (GOPE)','80',"","");
    document.getElementById("selTipoUsuarioPROSERVIPOL").options[4] = new Option('FISCALIZADOR (GOPE)','100',"","");
  }
...
function restablecerContrasena(tipoVentana)
{
  ...
  {
    alert("PROBLEMAS CON LA BASE DE DATOS 1");
    cerrarVentana();
  }
...
function borrarContrasena(tipoVentana)
{
	...
	objHttpXMLFuncionarios.send(encodeURI("codigoFuncionario="+codigo));
			...
			if (objHttpXMLFuncionarios.responseText != "OK")
			{
      alert("PROBLEMAS CON LA BASE DE DATOS 2");
      cerrarVentana();
      //alert(objHttpXMLFuncionarios.responseText);
    }
      else
     ...
     //alert(codUnidadPadreFuncionario);
       if(tipoUnidadFuncionario == 50){
        ...
        var unidad = 20;
           ...
           //objHttpXMLFuncionarios.send("codigoFuncionario="+codigo+"&unidadUsuario=20&tipoUsuario="+document.getElementById("selTipoUsuarioPROSERVIPOL").value);
            objHttpXMLFuncionarios.send("codigoFuncionario="+codigo+"&unidadUsuario="+unidad+"&tipoUsuario="+document.getElementById("selTipoUsuarioPROSERVIPOL").value);      
      }
      ...
      else
      {
          objHttpXMLFuncionarios.send("codigoFuncionario="+codigo+"&unidadUsuario="+codUnidadFuncionario+"&tipoUsuario="+document.getElementById("selTipoUsuarioPROSERVIPOL").value);
			...
			if (objHttpXMLFuncionarios.responseText != "OK"){
      alert("PROBLEMAS CON LA BASE DE DATOS 3");
      cerrarVentana();
      alert(objHttpXMLFuncionarios.responseText);
    }
...
function actualizaContrasena(tipoVentana)
{
  ...
  else
  {
      objHttpXMLFuncionarios.send("codigoFuncionario="+codigo+"&unidadUsuario="+codUnidadFuncionario+"&tipoUsuario="+document.getElementById("selTipoUsuarioPROSERVIPOL").value);
			...
			if (objHttpXMLFuncionarios.responseText != "OK"){
      alert("PROBLEMAS CON LA BASE DE DATOS 4");
      cerrarVentana();
      //alert(objHttpXMLFuncionarios.responseText);
    }
      else
