<?
  ...
  require("../../objetos/servicio.class.php");
	...
	$fechaTerminoReal = $_POST['fechaTermino'];
...
*/
$diasDiferencia=dias_transcurridos($fechaInicioReal,$fechaTermino);
//Fin diferencias
	...
	/*	
	$correlativos=$funcionario->getCorrelativo();	
	$arregloCorrelativos=unserialize(stripslashes($listaCorrelativo));
