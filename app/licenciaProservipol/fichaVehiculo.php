...
<body style="margin-top:10; margin-left:10; background-color:#d0d0d0" onload="javascript:leeProcedenciaVehiculos('selProcedencia');leeTipoVehiculos('selTipoVehiculo');leeSeccion('selSeccion');leeEstadosRecursos('selEstado','VEH'); leeMarcaVehiculos('selMarca');leeModeloVehiculos('','selModelo'); leeLugaresDeReparacion('selLugarReparacion');leeFallaVehiculo('selTipoFalla')" scroll="no">
