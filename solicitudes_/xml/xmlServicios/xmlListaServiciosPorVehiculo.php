<?
	...
	$objServicios->listaServiciosPorVehiculo($vehiculo, $fechaBuscar1, $fechaBuscar2, $servicio, &$servicios);
	...
	if ($servicios != ""){		
	  	...
	  	echo "<root>";
	   	for ($i=0; $i<$cantidad; $i++){
	   		...
	   		echo "<kmInicial>".$servicios[$i]->getMedioDeVigilancia(0)->getKmInicial()."</kmInicial>";
	   		echo "<kmFinal>".$servicios[$i]->getMedioDeVigilancia(0)->getKmFinal()."</kmFinal>";
	   		echo "</servicio>";
	 	}
		echo "</root>";
	} else {
