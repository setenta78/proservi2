...
<div style="width:99%;">
  <div id="divDatosServicio" style="position:absolute; visibility: visible; width:98%;">
  	...
  	<input type="hidden" id="unidadServicio" value="<?echo $unidad?>">
		<div id="marcoLevantado">
		    ...
		    <tr>
			  	...
			  	<td width="36%">
			    <select id="selTipoServicio" onChange="seleccionTipoServicio();">
 	      ...
 	      <tr>
			...
			<tr>
				<td>
					...
					<tr>
						<td><textarea onkeydown="limitarTextArea(this,2000)" id="textObservaciones" class="Texto_100" rows="16" onkeyup="this.value=sinCaracteres(this.value)" style="max-height:300px; max-width:900px;" ><?echo $textObservaciones;?></textarea></td>
					</tr>
					</table>
				</td>
			</tr>
  ...
  <div id="divAsignaFuncionarios" style="position:absolute; visibility: hidden; width:98%;">
		<div id="marcoLevantado">
		  <div id="cuadro">
		  ...
		  <div id="cuadro">
				...
				<tr>
					<td width="45%" rowspan="3">
						<select id="funcionariosDisponibles" size="26" style="max-height:320px;" multiple>
					...
					<td width="45%">
						<select id="personalAsignado" size="26" style="max-height:320px;" multiple>
						</select>
					</td>
				</tr>
				</table>
  ...
  <div id="divAsignaVehiculos" style="position:absolute; visibility: hidden; width:98%;">
		<div id="marcoLevantado">
		  <div id="cuadro">
			<table width="95%" border="0" align="center" cellpadding="0" cellspacing="0">
			<tr>
      ...
      <table width="95%" border="0" align="center" cellpadding="0" cellspacing="0">
    	...
    	<tr>
    		<td width="45%" rowspan="3">
    			<select id="vehiculosDisponibles" size="26" style="max-height:320px;" multiple><option value="0">CARGANDO VEH&Iacute;CULOS ... </option></select>
      	</td>
    		<td width="8%">
    		...
    		<td width="45%"><select id="vehiculosAsignados" size="26"  style="max-height:320px;" multiple></select></td>
    	</tr>
    	</table>
    	</div>
  	</div>
  </div>
  <div id="divAsignaAnimales" style="position:absolute; visibility: hidden; width:98%;">
		<div id="marcoLevantado">
		  <div id="cuadro">
			<table width="95%" border="0" align="center" cellpadding="0" cellspacing="0">
			<tr>
		  ...
		  <div id="cuadro">
	    	<table width="95%" border="0" align="center" cellpadding="0" cellspacing="0">
		    	...
		    	<tr>
	      		<td width="45%" rowspan="3"><select id="caballosDisponibles" size="12" style="max-height:150px;" multiple><option value="0">CARGANDO CABALLOS ... </option></select>
	      			<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
	    					<tr><td height="30" width="45%" id="tituloSelecMultiple"><div id="tituloPerroDisponible">PERROS DISPONIBLES</div></td></tr>
	    					<tr><td width="100%" rowspan="3">	<select id="perrosDisponibles" size="12" style="max-height:150px;" multiple><option value="0">CARGANDO PERROS POLICIALES ... </option></select> </td></tr>
	      			</table>
	        	</td>
	      		<td width="8%">
	      		...
	      		<td width="45%">
	      			<select id="animalesAsignados" size="26"  style="max-height:320px;" ></select>
	        	</td>
		    	</tr>
	    	</table>
      </div>
...
<!-- Inicio -->
<div id="divAsignaMedios" style="position:absolute; visibility: hidden; width:98%;">
	...
	<div id="marcoLevantado">
		<div id="cuadro">
			<table width="95%" border="0" align="center" cellpadding="0" cellspacing="0">
				...
				<tr>
					<td width="45%" rowspan="7"><select id="personalServicio" size="20" style="max-height:250px;" multiple></select></td>
					...
					<td width="45%"><select id="personalServicioMedio" size="5" style="max-height:90px;" multiple></select></td>
				</tr>
				<tr>
				...
				<tr>
					<td>
						<table>
							<tr>
								<td>
									<fieldset id="cuadro2" style="width:200px">
										...
										<table cellpadding="0" cellspacing="0" width="100%">
											<tr style="padding: 6px 0px 0px 0px">
												...
												<td width="40%"><input id="textKmInicial" name="textKmInicial" type="text"></td>
											</tr>
								...
								<td>
									<fieldset id="cuadro2" style="width:200px">
										...
										<table cellpadding="0" cellspacing="0" width="100%">
											<tr>
												<td align="right" style="padding: 5px 0px 0px 0px"><select id="cuadrantesMV" size="3" multiple></select></td>
											</tr>
										</table>
									</fieldset>
								</td>
				...
				<tr>
					<td>
						<fieldset id="cuadro3" style="width:98.7%;">
							...
							<table cellpadding="0" cellspacing="0" width="100%" border="0">
								<tr>
									<td align="right" colspan="2" style="padding: 0px 0px 0px 0px"><select id="factorMV" style="padding: 5px 0px 0px 0px"></select></td>
								</tr>
							</table>
						</fieldset>
					</td>
		...
		<fieldset id="cuadro2" style="padding: 0px 0px 0px 0px">
...
<!-- Fin -->
  <div id="divAsignaAccesorios" style="visibility: hidden; width:98%;" style="max-height:380px;">
  <input id="idLA" type="hidden">
		<div id="marcoLevantado" style="padding: 12px 0px 10px 0px;">
	    	...
	    	<tr> 
	      	<td width="45%" valign="top"><select id="armasDisponibles" size="9" style="max-height:150px;" multiple="yes"></select></td>
	      	...
	      	<td rowspan="4" colspan="5">
		      	...
		      	<fieldset id="cuadro2">
							...
							<tr>
				   			...
				   			<div id="listadoPersonalAccesorios" style="max-height:280px;" ></div>
				</div>
				</td>
				</tr>
				</table>
	    	...
	    	<tr> 
	      	<td><select id="accesoriosDisponibles" size="9" multiple="yes"><option value="0">CARGANDO ACCESORIOS ... </option></select></td>
	    	</tr>
			</table>
		</div>
	</div>
  <div style="padding:10 0px 0px 0px;"></div>
  <table width="100%">
  <tr>
