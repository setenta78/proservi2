...
//------------------------------------TERMINAR LA FUNCION EN 0 PARA QUE INICIE EN EL DIA ACTUAL EN LA SIGUIENTE LINEA----------------------------------------------
	...
	function popUpCalendar(ctl,	ctl2, format, posX, posY) {
		var	leftpos=-190
		var	toppos=-10
		
		fixedX = posX;		//lo agregue yo
		fixedY = posY;		//lo agregue yo
...
//------------------------------------TERMINAR LA FUNCION EN 0 PARA QUE INICIE EN EL DIA ACTUAL EN LA SIGUIENTE LINEA----------------------------------------------
		...
		function popUpCalendar2(ctl,	ctl2, format, posX, posY) {
		var	leftpos=-190
		var	toppos=-10
