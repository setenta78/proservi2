<div class="fichaOculta" id="fichaClaveUsuario">
<link href="./css/aplicacion.css?v=<?echo version?>" rel="stylesheet" type="text/css">
<link href="./css/FichaClaveUsuario.css?v=<?echo version?>" rel="stylesheet" type="text/css">
	<div id="fichaContenedor" class="ficha-contenedor">
		<div class="ficha-header"><div class="ficha-titulo">Gesti&oacute;n de Usuario</div></div>
...
<div style="width:60%; margin-left:10px;">
	...
	<table cellpadding="0" cellspacing="5" width="100%">
		...
		<tr>
			...
			<td><input id="textContrasenaOld" type="hidden"><input id="textContrasena" type="password" style="position: relative;width:70%;top: -8px;" ><img src="images/eyeClose.png" id="imgContrasena" value="0" width="30px" height="30px" style="position: relative; top: 2px; left: 5px; cursor:pointer;" ></td>
		</tr>
	</table>
    <br>
	</div>
	...
	<table cellpadding="0" cellspacing="0" width="100%">
		...
		<tr>
			...
			<td>
                ...
                <input id="codUnidadPadre" type="hidden">
                <input id="codUnidadOrigen" type="hidden">
                <input id="descUnidadOrigen" type="hidden">
