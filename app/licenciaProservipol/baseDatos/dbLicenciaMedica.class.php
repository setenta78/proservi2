...
function buscaFuncionarioLicencia($rut, $funcionarios){
	    ...
	    $sql = "SELECT 
          ...
          CARGO_FUNCIONARIO.CANT_DIAS
				...
				WHERE
				  CARGO_FUNCIONARIO.FECHA_HASTA IS NULL	AND CARGO_FUNCIONARIO.CAR_CODIGO NOT IN(1000,2000,3500)  AND
	...
	function buscaFichaLicencia($codFuncionario, $color, $folio, $funcionarios){
      ...
      //$result = 1;	
		...
		//        FUNCIONARIO.UNI_CODIGO=7800";			
		        ...
		        WHERE
		           LICENCIA_MEDICA.UNI_CODIGO='".$Unidad."' AND LICENCIA_MEDICA.ESTADO_LICENCIA=1";
