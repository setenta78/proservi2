...
if(codUnidadFuncionario == "")
{
    ...
    document.getElementById("selTipoUsuarioPROSERVIPOL").options[4] = new Option('FISCALIZADOR','90',"","");
    document.getElementById("selTipoUsuarioPROSERVIPOL").options[5] = new Option('CONSULTA FISCALIZADOR','100',"","");
