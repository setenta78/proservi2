<?
	...
	$objFuncionarios->bucaFuncionarios($codigoFuncionario, &$funcionarios);
  	...
  	if ($cantidad > 0){
	  	...
	  	echo "<root>";
	   	for ($i=0; $i<$cantidad; $i++){
     	    ...
     	    echo "<codigoSeccion>".$funcionarios[$i]->getSeccion()->getCodigo()."</codigoSeccion>"; //Tag agregado el 28-04-2015
			echo "<seccion>".$funcionarios[$i]->getSeccion()->getDescripcion()."</seccion>"; //Tag agregado el 28-04-2015
