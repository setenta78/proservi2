    ...
    <div class="ml-64 w-full mt-20 p-5">
      ...
      <div class="flex justify-center mb-4">
        ...
        <div class="w-full max-w-md">
          <form action="queries/recibe_excel_validando.php" method="POST" enctype="multipart/form-data" class="bg-white shadow-lg p-6 rounded-lg">
      ...
      <div class="container mx-auto mt-20 p-5">
        ...
        <div class="flex justify-center mb-4">
          <form action="" method="GET" class="w-full max-w-lg flex items-center">
            <input type="text" name="search" placeholder="Buscar por Marca, Modelo, Procedencia, etc." class="w-full p-2 border rounded-l-lg focus:outline-none focus:ring focus:border-green-500" value="<?= htmlspecialchars($_GET['search'] ?? '') ?>">
        ...
        // Ordenación segura
        $allowed_sort_columns = array('VC_CODIGO', 'MVC_DESCRIPCION', 'MODVC_DESCRIPCION'); // Define columnas válidas
