...
<?
	...
	$tipoUnidad			    = $_SESSION['USUARIO_TIPOUNIDAD']; //Variable de sesion añadida el 17-04-2015
...
<script type="text/javascript" src="./js/seccion.js"></script><!--Archivo JS añadido el 17-04-2015-->
</head>
<body style="margin-top:10; margin-left:10; background-color:#d0d0d0" onload="javascript:leeEscalafon('selEscalafon'); leeCargos('selCargo'); leeSeccion('selSeccion');leeCuadrantes('<? echo $unidadUsuario?>',false,'selCuadrante',false);" scroll="no">
...
<input id="tipoUnidad"  type="hidden" readonly="yes" value="<?echo $tipoUnidad?>"><!--Variable oculta añadida el 17-04-2015-->
<input id="seccionBaseDatos" type="hidden" readonly="yes"><!--Variable oculta añadida el 17-04-2015-->
<input id="contieneHijos" type="hidden" readonly="yes" value="<?echo $contieneHijos?>"><!--Variable oculta añadida el 17-04-2015-->
<input id="textRutFuncionario" type="hidden" readonly="yes" value="">
...
<div id="marcoLevantado">
	...
	<table cellpadding="0" cellspacing="0" width="100%">
    	<tr id="filaSeccion" style="padding: 0px 0px 0px 0px">
			...
			<td width="67%" colspan="2"><select id="selSeccion" disabled="yes" onChange="activaFechaNuevoCargo()></select></td>
			<td width="3%"></td>
    	</tr>
		<tr style="padding: 0px 0px 0px 0px">
			<td width="30%" align="right">(*) CARGO&nbsp;(FUNCIÓN)&nbsp;:&nbsp;</td>
			<td width="67%" colspan="2"><select id="selCargo" disabled="yes" onChange="activaFechaNuevoCargo();activaLicencia()"></select></td>
			<td width="3%"></td>
		</tr>
...
<table width="105%">
<tr> 
	  <td width="15%"><input name="btnDejarDisponible" type="button" id="btn100" value="TRASLADO"  disabled="true"></td>
	  <td width="15%"><input name="btnRetiro" type="button" id="btn100" value="RETIRO" disabled="yes"></td>
	  <td width="15%"><input name="btnBaja" type="button" id="btn100" value="BAJA" disabled="yes"></td>
   	  <td width="15%">&nbsp;</td>
      <td width="20%"><input name="btnGuardarOrganizacion" type="button" id="btn100" value="GUARDAR"  disabled="yes"></td>
