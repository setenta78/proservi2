...
function licenciaSemep(){
	...
	if (document.getElementById("optionSemep").checked){
		...
		document.getElementById("textFechaHabilitacionSemep").className 					= "deshabilidado"; //Desactivado
		document.getElementById("textFechaRenovacionSemep").className 						= "habilidado";
		document.getElementById("imagenCalendarioHabilitacionSemep").className				= "calendarioDeshabilidado"; //Desactivado
		...
		document.getElementById("textFechaHabilitacionSemep").disabled						= "true"; //Desactivado
