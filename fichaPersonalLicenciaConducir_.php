...
<div id="divSubirArchivo" style="display:none;">
	<div id="marcoLevantado">
		<table width="100%">
			...
			<input type="hidden" name="codigoFuncionarioPaso" value="<?echo $codigoFuncionario?>" />
			<input type="hidden" name="subirArchivo" value="1" />
			...
			<tr>
				<td align="right" width="50%">
					<input type="button" value="CANCELAR" id="btnSubir" onClick="cerrarSubirArvhivo(this)" />
				</td>
				<td align="right" width="50%">
					<input type="submit" value="ACEPTAR" id="btnSubir" onClick="aceptarImagenDocumento()" />
				</td>
			</tr>
		</table>
	</div>
...
<tr> 
  ...
  <td width="15%">
   	<? //if ($unidadUsuario == -1){?>
   	 <input name="btnGuardarOrganizacion" type="button" id="btn100" value="ELIMINAR" onClick="eliminarDatosLicenciaConducir()" <? if($codPerfil==70 || $codPerfil==80 || $codPerfil == 90 || $codPerfil == 100) echo 'disabled'; else echo 'enabled'; ?>>
   	<?//}?>
  </td>
	<td width="15%"><input name="btnGuardarOrganizacion" type="button" id="btn100" value="GUARDAR" onClick="guardarDatosLicenciaConducir()" <? if($codPerfil==70 || $codPerfil==80 || $codPerfil == 90 || $codPerfil == 100) echo 'disabled'; else echo 'enabled'; ?>></td>
