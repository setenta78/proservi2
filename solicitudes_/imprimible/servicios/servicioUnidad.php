...
FROM
  ...
  INNER JOIN SERVICIO ON (SERVICIOS_CERTIFICADO.UNI_CODIGO = SERVICIO.UNI_CODIGO AND SERVICIOS_CERTIFICADO.FECHA_SERVICIOS = SERVICIO.FECHA)
...
WHERE
SERVICIO.CORRELATIVO_SERVICIO='".$correlativo."' AND
