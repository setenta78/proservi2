...
session_start();
  ...
  $codigoUnidad			= $_SESSION['USUARIO_CODIGOUNIDAD'];   	 
	...
	$vehiculo->setMarca(STRTOUPPER($marca2));
	$vehiculo->setModelo(STRTOUPPER($modelo2));
