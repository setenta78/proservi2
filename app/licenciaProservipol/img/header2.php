...
<div id="banner"></div>
<div id="usuario">
	<div id="nombreUnidad">CARABINEROS DE CHILE - DPTO. CONTROL DE GESTION P.M.</div>
	<div id="linea1"></div>
	...
	<table width="100%" border="0">
	  <tr> 
		 ...
		 <?if ($codigoPerfil == 10 || $codigoPerfil == 20){?>
		 	<ul class="menuPrincipal">    
				...
				<li><a href="serviciosConsulta.php">Volver</a></li>
			</ul>
		<?}?>
	 ...
	 <?if ($codigoPerfil == 90){?>
		 	<ul class="menuPrincipal">    
				...
				<li><a href="vehiculosUnidadesHijos.php">Vehiculos</a></li>
				<li><a href="controlIngresoDatos.php">Control</a></li>
                <li><a href="serviciosConsulta.php">Fiscalizaci&oacute;n</a></li>
				<li><a href="javascript:cerrarAplicacion()">Cerrar</a></li>
			</ul>
		<?}?>
