...
<legend style="font-weight:bold;font-family:Verdana;font-size: 12px;color:#00000;">BUSCAR ARMA</legend>
<br>
<table border="0">
<tr>
<td>&nbsp;Numero Serie del Arma </td>
<td>:&nbsp;<input type="text" id="textNSerie" name="texto" class="campos" size="10" value="" maxlength="7" onkeyup="autocompletar('lista','listaFechas',this.value);" /></td>
</tr>
</table>
</fieldset>
