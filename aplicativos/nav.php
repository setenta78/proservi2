...
<aside class="fixed top-16 w-64 h-full bg-gray-500 text-white">
    <ul class="space-y-1 p-4 text-sm">
            ...
            <div class="mt-10 max-w-sm mx-auto bg-white shadow-lg rounded-lg overflow-hidden">
                <div class="sm:flex sm:items-center px-6 py-4">
                    ...
                    <div class="mt-4 sm:mt-0 sm:ml-4 text-center sm:text-left">
                        <p class="text-sm leading-tight text-gray-600 font-semibold">Daniela Parra Pavez</p>
        ...
        <!--  <li>
            <a href="camaras.php" class="flex items-center space-x-2 py-2 px-4 rounded <?php echo ($current_page == 'camaras.php') ? 'bg-green-700 text-white' : 'hover:bg-gray-700'; ?>">
        ...
        <li>
            <?php
            // Determinar qué página cargar según la versión de PHP
        ...
        <!--  <li>
            <a href="manual.php" class="flex items-center space-x-2 py-2 px-4 rounded <?php echo ($current_page == 'manual.php') ? 'bg-green-700 text-white' : 'hover:bg-gray-700'; ?>">
