...
<body style="margin-top:10; margin-left:10; background-color:#d0d0d0" scroll="no" onload="rutUsuario();reparticionCodigo();">
...
<input type="text" id="textFechaTermino" name="textFechaTermino" value="">
...
<td><input type="text" id="txtcolor" name="txtcolor" size="1" style="text-transform:uppercase;" onkeyup="javascript:this.value=this.value.toUpperCase();" value="" onKeypress="maximo(this,1,'C')" onblur="validarSubir();"></td>
<td><b>(*) FOLIO:</b></td>
<td><input type="text" id="txtfolio" name="txtfolio" size="11" value="" onKeypress="maximo(this,11,'N')" onblur="validarSubir();"></td>
</tr>
</table>
</div>
...
<tr>
<td align="center"><input type="text" id="txtdias" name="txtdias" size="2" onKeypress="maximo(this,2,'N')"></td>
<td></td>
<td align="center">
...
<td><select id="cboLicencia" onchange="hijomenor()" >
  ...
  <option value="180">LICENCIA MATERNAL PRE Y POST NATAL</option>
  <option value="162">ENFERMEDAD GRAVE HIJO MENOR DE UN AÑO</option>
  <option value="628">ACCIDENTE DEL TRABAJO</option>
...
<tr>
<td align="center"><select id="cboEspecialidad">
<option value="0">SELECCIONE UNA OPCION ...</option>
<option value="1">TRAUMATOLOGIA</option>
<option value="2">OFTAMOLOGIA</option>
<option value="3">UROLOGIA</option>
<option value="4">GASTROENTEROLOGIA</option>
<option value="5">NEUROLOGIA</option>
<option value="6">UROLOGIA</option>
<option value="7">PROCTOLOGIA</option>
