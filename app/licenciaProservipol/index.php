...
<body>
	...
	<div class="content">
	<!--<marquee>Próximo cierre correspondiente al mes de <strong>Abril de 2017</strong> esta programado para el día  <strong>Viernes 05 de Mayo</strong> a las 17:00 hrs. </marquee>-->
		<div id="login">		
			<form method="post" action="valida.php" id="form1" name="form1">
				<h2>SISTEMA <br/> 				
					PROSERVIPOL (LICENCIAS)
				</h2>
