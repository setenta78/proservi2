<?  
	...
	//echo "ksdhksfjdhj" . $nombreArchivo;
	...
	if ($existeLicenciaMunicipal == 1)	{
		$resultado = $objDBLicenciasDeConducir->deleteLicenciaConducirMunicipal($licenciasDeConducir[0]);
	...
	if ($existeLicenciaSemep == 1) {
		$resultado = $objDBLicenciasDeConducir->deleteLicenciaConducirSemep($licenciasDeConducir[1]);
